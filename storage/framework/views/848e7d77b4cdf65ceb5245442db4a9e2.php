...
<title><?php echo e(websiteTitle('Stock Transfer')); ?></title>
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Stock Transfer</h3>
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.stockTransferAction','create')); ?>">New Transfer</a>
            <?php endif; ?>
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.stockTransfer')); ?>">
    ...
    <div class="card-content">
        <div id="accordion">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.stockTransfer')); ?>">
                        <div class="row">
...
<div class="card">
    <div class="card-header" style="border-bottom: 1px solid #e3ebf3;">
        <h4 class="card-title">Stock Transfer History List</h4>
    </div>
    <div class="card-content">
        <div class="card-body">
            <form action="<?php echo e(route('admin.stockTransfer')); ?>">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <ul class="statuslist">
                            <li><a href="<?php echo e(route('admin.stockTransfer')); ?>">All (<?php echo e($totals->total); ?>)</a></li>
                            <li><a href="<?php echo e(route('admin.stockTransfer',['status'=>'pending'])); ?>">Pending (<?php echo e($totals->pending); ?>)</a></li>
                            <li><a href="<?php echo e(route('admin.stockTransfer',['status'=>'delivered'])); ?>">Delivered (<?php echo e($totals->delivered); ?>)</a></li>
                            <li><a href="<?php echo e(route('admin.stockTransfer',['status'=>'cancelled'])); ?>">Cancelled (<?php echo e($totals->cancelled); ?>)</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 150px;">Form Store/Branch</th>
                                <th style="min-width: 150px;">To Store/Branch</th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.stockTransferAction',['invoice',$invoice->id])); ?>"><?php echo e($invoice->invoice); ?></a>
                                        <a href="<?php echo e(route('admin.stockTransferAction',['edit',$invoice->id])); ?>" class="badge badge-info"><i class="fa fa-edit"></i></a>
                                    </td>
                                    <td>
                                        <?php if($invoice->formBranch): ?>
                                        <?php echo e($invoice->formBranch->name); ?>
...
<?php echo $__env->make(general()->adminTheme.'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/stock-transfer/orderList.blade.php ENDPATH**/ ?>