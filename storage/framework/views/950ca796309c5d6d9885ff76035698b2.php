...
<div class="row">
	<div class="form-group col-md-4">
        ...
        <a href="<?php echo e(route('admin.productsAction',['barcode',$product->id])); ?>" target="_blank" style="color: #ff864a;font-size: 12px;font-weight: bold;display: block;">Print  <i class="fa fa-barcode" style="color: black;"></i> </a>
        <?php endif; ?>
		</label>
...
<?php /**PATH D:\xampp\htdocs\posher-react-laravel\resources\views/admin/products/includes/productsDataGeneral.blade.php ENDPATH**/ ?>