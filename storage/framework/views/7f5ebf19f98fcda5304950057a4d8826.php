	 ...
	 <div class="modal-content">
	   ...
	   <div class="modal-body">
			...
			<div class="tab-content px-1 pt-1" style="border: 1px solid #ddd;">
				...
				<form action="<?php echo e(route('admin.ordersAction',['payment',$invoice->id])); ?>" method="post">
					<?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/wholesale/includes/paymentModal.blade.php ENDPATH**/ ?>