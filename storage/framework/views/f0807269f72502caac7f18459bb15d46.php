...
<ul>
	<?php $__currentLoopData = $searchProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $searchProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    	<?php if($searchProduct->variation_status): ?>
        	...
        	<li data-url="<?php echo e(route('admin.stockTransferAction',['add-product',$invoice->id])); ?>" data-id="<?php echo e($searchProduct->id); ?>" data-variant="<?php echo e($item->id); ?>">
        	    <?php echo $item->variationItemValues(); ?> -	<?php echo e($searchProduct->name); ?> <?php echo e($item->barcode?'| '.$item->barcode:''); ?>

        	</li>
        	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    	<?php else: ?>
    	<li data-url="<?php echo e(route('admin.stockTransferAction',['add-product',$invoice->id])); ?>" data-id="<?php echo e($searchProduct->id); ?>" data-variant="">
...
<?php endif; ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/stock-transfer/includes/searchResult.blade.php ENDPATH**/ ?>