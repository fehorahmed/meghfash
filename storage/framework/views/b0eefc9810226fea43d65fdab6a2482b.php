                                    ...
                                    <div class="col-md-5" style="padding:15px;">
                                        <div class="SearchContain">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control serchProducts" data-url="<?php echo e(route('admin.purchasesAction',['search-product',$invoice->id])); ?>" placeholder="Search Product Name, ID" autocomplete="off">
                                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/purchases/purchasesEdit.blade.php ENDPATH**/ ?>