                ...
                <div class="varitaionItemproduct">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" class="form-control purchase_price_0" name="variation_purchase_price" value="<?php echo e($product->purchase_price); ?>"  placeholder="Purchase price">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Wholesale Price <small>(40%)</small></label>
                            <input type="number" class="form-control wholesale_price_0" name="variation_wholesale_price" value="<?php echo e($product->wholesale_price); ?>"  placeholder="Wholesale price">
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="varitaionItemproduct_<?php echo e($itemEdit->id); ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Purchase Price <small>(50%)</small></label>
                            <input type="number" class="form-control purchase_price_<?php echo e($itemEdit->id); ?>" name="variation_purchase_price" value="<?php echo e($itemEdit->purchase_price); ?>"  placeholder="Purchase price">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Wholesale Price <small>(40%)</small></label>
                            <input type="number" class="form-control wholesale_price_<?php echo e($itemEdit->id); ?>" name="variation_wholesale_price" value="<?php echo e($itemEdit->wholesale_price); ?>"  placeholder="Wholesale price">
                        </div>
                    </div>
...
</div><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/products/includes/productsDataAttributes2.blade.php ENDPATH**/ ?>