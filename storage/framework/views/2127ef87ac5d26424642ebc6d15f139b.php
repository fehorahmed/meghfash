        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    ...
                    <?php if(isset(json_decode(Auth::user()->permission->permission, true)['appsSetting']['general'])): ?> 
                    <?php if($general->logo): ?>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    ...
                    <input type="file" name="pos_logo" class="form-control <?php echo e($errors->has('pos_logo')?'error':''); ?>" />
                    <?php if($errors->has('pos_logo')): ?>
                    <p style="color: red; margin: 0;"><?php echo e($errors->first('pos_logo')); ?></p>
                    <?php endif; ?>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    <img src="<?php echo e(asset($general->posLogo())); ?>" style="max-width: 150px;" />
                    <?php if(isset(json_decode(Auth::user()->permission->permission, true)['appsSetting']['general'])): ?> <?php if($general->pos_logo): ?>
                    <a href="<?php echo e(route('admin.setting','pos_logo')); ?>" style="color: red;" onclick="return confirm('Are You Want To Delete?')"><i class="fa fa-trash"></i></a>
                    <?php endif; ?> <?php endif; ?>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td style="padding: 2px;">
                                    <input type="text" name="patho_client_id" value="<?php echo e($general->patho_client_id); ?>" placeholder="Client ID" class="form-control <?php echo e($errors->has('patho_client_id')?'error':''); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Client Secret</th>
                                <td style="padding: 2px;">
                                    <input type="text" name="patho_client_secret" value="<?php echo e($general->patho_client_secret); ?>" placeholder="Client Secret" class="form-control <?php echo e($errors->has('patho_client_secret')?'error':''); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Username</th>
                                <td style="padding: 2px;">
                                    <input type="text" name="patho_username" value="<?php echo e($general->patho_username); ?>" placeholder="Username" class="form-control <?php echo e($errors->has('patho_username')?'error':''); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Password</th>
                                <td style="padding: 2px;">
                                    <input type="text" name="patho_password" value="<?php echo e($general->patho_password); ?>" placeholder="Password" class="form-control <?php echo e($errors->has('patho_password')?'error':''); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Webhook Secret</th>
                                <td style="padding: 2px;">
                                    <input type="text" name="pathao_webhook" value="<?php echo e($general->pathao_webhook); ?>" placeholder="Webhook Secret" class="form-control <?php echo e($errors->has('pathao_webhook')?'error':''); ?>">
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td style="padding: 2px;">
                                    <input type="text" name="carrybee_username" value="<?php echo e($general->carrybee_username); ?>" placeholder="Username" class="form-control <?php echo e($errors->has('carrybee_username')?'error':''); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Password</th>
                                <td style="padding: 2px;">
                                    <input type="text" name="carrybee_password" value="<?php echo e($general->carrybee_password); ?>" placeholder="Password" class="form-control <?php echo e($errors->has('carrybee_password')?'error':''); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Webhook Secret</th>
                                <td style="padding: 2px;">
                                    <input type="text" name="carrybee_webhook" value="<?php echo e($general->carrybee_webhook); ?>" placeholder="Webhook Secret" class="form-control <?php echo e($errors->has('carrybee_webhook')?'error':''); ?>">
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td style="padding: 2px;">
                                    <input type="text" name="steadfast_api_key" value="<?php echo e($general->steadfast_api_key); ?>" placeholder="Api Key" class="form-control <?php echo e($errors->has('steadfast_api_key')?'error':''); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Secret-Key</th>
                                <td style="padding: 2px;">
                                    <input type="text" name="steadfast_secret_key" value="<?php echo e($general->steadfast_secret_key); ?>" placeholder="Secret Key" class="form-control <?php echo e($errors->has('steadfast_secret_key')?'error':''); ?>">
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td style="padding: 2px;">
                                <input type="text" name="fb_pixel_id" value="<?php echo e($general->fb_pixel_id); ?>" placeholder="Pixel ID" class="form-control <?php echo e($errors->has('fb_pixel_id')?'error':''); ?>">
                            </td>
                        </tr>
                        <tr>
                            <th>Access Token</th>
                            <td style="padding: 2px;">
                                <input type="text" name="fb_access_token" value="<?php echo e($general->fb_access_token); ?>" placeholder="Access Token" class="form-control <?php echo e($errors->has('fb_access_token')?'error':''); ?>">
                            </td>
                        </tr>
                    </table>
                </div>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/fehor/AAAAA/Other/meghfash/resources/views/admin/setting/general.blade.php ENDPATH**/ ?>