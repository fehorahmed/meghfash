...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.ordersReturn')); ?>"><i class="fa fa-list"></i> Back</a>
            
            <a class="btn btn-success" href="<?php echo e(route('admin.ordersReturnAction',['invoice',$order->id])); ?>"><i class="fa fa-print"></i> Invoice</a>
            
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.ordersReturnAction',['update',$order->id])); ?>">
    ...
    <section class="basic-elements">
        <div class="row">
            <div class="col-md-12">
			    ...
			    <form  method="post" action="<?php echo e(route('admin.ordersReturnAction',['update',$order->id])); ?>">
    				<?php echo csrf_field(); ?>
                	<div class="card">
                            		...
                            		<div class="col-md-6">
                            			...
                            			<table class="table table-borderless">
                            			    <tr>
    		                        			...
    		                        			<td>
    		                        			    <?php if($order->parentOrder): ?>
    		                        			    <a href="<?php echo e(route('admin.invoice',$order->parentOrder->id)); ?>" target="_blank"><?php echo e($order->parentOrder->invoice); ?></a>
    		                        			    <?php else: ?>
    		                        			    <span>Not Found</span>
    		                        			    <?php endif; ?>
    		                        			</td>
    		                        		...
    		                        		<tr>
    		                        			...
    		                        			<td style="padding:3px;">
    		                        			    <input type="date" name="created_at" value="<?php echo e($order->created_at->format('Y-m-d')); ?>" class="form-control form-control-sm" required="">
    		                        			 </td>
    		                        		</tr>
    		                        		<tr>
    		                        			<th>Return Note:</th>
                        ...
                        <div class="card-content">
                            <div class="card-body">
				                ...
				                <div class="table-responsive m-t orderItem">
                                    <?php echo $__env->make(adminTheme().'returns.includes.orderItems', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				                </div>
                            ...
                            <table class="table table-bordered">
                               ...
                               <tr>
                                ...
                                <td><?php echo e($transaction->currency); ?> <?php echo e(number_format($transaction->amount,2)); ?>
                                    ...
                                    <br>
                                    <a href="<?php echo e(route('admin.ordersReturnAction',['payment-delete',$order->id,'transection_id'=>$transaction->id])); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Want To Delete?')">Delete</a>
                                </td>
                               </tr>
	 ...
	 <div class="modal-content">
	   ...
	   <div class="modal-body">
			...
			<div class="tab-content px-1 pt-1" style="border: 1px solid #ddd;">
				...
				<form action="<?php echo e(route('admin.ordersReturnAction',['payment',$order->id])); ?>" method="post">
					<?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/returns/ordersReturnEdit.blade.php ENDPATH**/ ?>