                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.products')); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    <div class="input-group">
                                        <input type="text" name="search" value="<?php echo e($r->search?$r->search:''); ?>" placeholder="Product Name, Category Name" class="form-control <?php echo e($errors->has('search')?'error':''); ?>" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <ul class="statuslist">
                            ...
                            <li><a href="<?php echo e(route('admin.products',['status'=>'newarrival'])); ?>">New Arrival (<?php echo e($totals->newarrival); ?>)</a></li>
                        </ul>
                    </div>
                </div>
...
<?php echo $__env->make(general()->adminTheme.'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/products/productsAll.blade.php ENDPATH**/ ?>