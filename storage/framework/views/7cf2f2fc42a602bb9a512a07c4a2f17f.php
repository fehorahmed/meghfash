...
<title><?php echo e(websiteTitle('Wholesale return List')); ?></title>
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Wholesale return List</h3>
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Dashboard </a></li>
                    <li class="breadcrumb-item active">Wholesale return List</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.wholesaleReturn')); ?>">
    ...
    <div class="card-content">
        <div id="accordion">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.wholesaleReturn')); ?>">
                            <div class="row">
...
<div class="card">
    <div class="card-header" style="border-bottom: 1px solid #e3ebf3;">
        <h4 class="card-title">Wholesale return List</h4>
    </div>
    <div class="card-content">
        <div class="card-body">
            <form action="<?php echo e(route('admin.wholesaleReturn')); ?>">
                    ...
                    <table class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('admin.wholesaleReturnAction',['invoice',$order->id])); ?>"><?php echo e($order->invoice); ?></a></td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.wholesaleReturnAction',['edit',$order->id])); ?>" class="btn btn-sm btn-success">Edit</a>
                                    <a href="<?php echo e(route('admin.wholesaleReturnAction',['delete',$order->id])); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you want to delete?')"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
...
<div class="modal fade text-left" id="AddRetun" tabindex="-1" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('admin.wholesaleReturnAction','create')); ?>">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel1">Wholesale Order Return</h4>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/returns/wholesaleReturn.blade.php ENDPATH**/ ?>