...
<footer>
                ...
                <div class="col-md-3 col-12">
                    <div class="aboutCompa">
                        <a href="<?php echo e(route('index')); ?>">
                            <img src="<?php echo e(asset('public/welcome/images/Group 71.png')); ?>" alt="Bytebliss">
                        </a>
    ...
    <div class="bootmFot">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <p>2024 Copyright <a href="<?php echo e(route('index')); ?>">©Bytebliss. </a>All Rights Reserved.</p>
                </div>
                <div class="col-md-6">
                    <a href="#" class="paymentImg"><img src="<?php echo e(asset('public/welcome/images/image 37.png')); ?>" alt="Bytebliss"></a>
                </div>
            </div>
        </div>
    </div>
</footer>
<!-- footer part end  --><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/welcome/layouts/footer.blade.php ENDPATH**/ ?>