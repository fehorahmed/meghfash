                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-1">
                                    <select  name="category" class="form-control" >
                                        ...
                                        <option value="<?php echo e($ctg->id); ?>" <?php echo e($r->category==$ctg->id?'selected':''); ?> ><?php echo e($ctg->name); ?></option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <ul class="statuslist">
                            ...
                            <li><a href="<?php echo e(route('admin.products',['status'=>'web_view'])); ?>">For Web (<?php echo e($totals->inactiveView); ?>)</a></li>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <b>ID:</b> <?php echo e($product->id); ?>

                                </td>
                                <td>
                                    <span><a href="<?php echo e(route('productView',$product->slug?:'no-slug')); ?>" target="_blank"><?php echo e($product->name); ?></a></span>
                                    <br/>
                                    <span style="color: #ccc;"><b style="color: #1ab394;"><?php echo e(general()->currency); ?></b> 
                                    <?php echo e(priceFormat($product->offerPrice())); ?>

                                    <?php if($product->offerPrice() < $product->regular_price): ?>
                                    <del style="color: #FF5722;font-size: 12px;"><?php echo e($product->regularPrice()); ?></del>
                                    <?php endif; ?>
                                    </span>
...
<?php echo $__env->make(general()->adminTheme.'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/products/productsAll.blade.php ENDPATH**/ ?>