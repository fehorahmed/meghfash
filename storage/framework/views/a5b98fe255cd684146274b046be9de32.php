<!DOCTYPE html>
 <html class="loading" lang="en" >
   ...
   <!-- BEGIN: Body-->
   <body class="vertical-layout vertical-menu-modern 2-columns fixed-navbar hell <?php echo e(Request::is('admin/pos-sales*')? 'menu-collapsed' : ''); ?> " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
   ...
   <!-- END: Body-->
 </html><?php /**PATH D:\xampp\htdocs\posher-react-laravel\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>