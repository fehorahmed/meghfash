				...
				<div class="row" style="flex-wrap: wrap;">
					<div class="col-4">
						<p>
							...
							<?php if($order->courier && $order->courier_id): ?>
    							<br>
    							<br>
    						    <b style="font-size: 16px;">Courier: <?php echo e($order->courier); ?> - <?php echo e($order->courier_id); ?></b>
							<?php endif; ?>
						</p>
					</div>
					<div class="col-2">
...
<?php /**PATH /home/meghfash/public_html/resources/views/admin/orders/includes/invoiceView.blade.php ENDPATH**/ ?>