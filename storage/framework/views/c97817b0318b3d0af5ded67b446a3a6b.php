...
<title><?php echo e(websiteTitle('Warehouse/Branch')); ?></title>
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Warehouse/Branch</h3>
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Dashboard </a></li>
                    <li class="breadcrumb-item active">Warehouse/Branch</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header" style="border-bottom: 1px solid #e3ebf3;">
                        <h4 class="card-title">Warehouse/Branch</h4>
                    </div>
                                                        ...
                                                        <form action="<?php echo e(route('admin.productsWarehousesAction',['update',$warehouse->id])); ?>" method="post">
                                                           ...
                                                           <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name"  class="form-control" value="<?php echo e($warehouse->name); ?>" placeholder="Enter method name" required="">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Image</label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/products/warehouses/warehousesAll.blade.php ENDPATH**/ ?>