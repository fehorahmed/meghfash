   ...
   <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
     <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
       ...
       <a class="btn btn-outline-primary" href="<?php echo e(route('admin.usersCustomer')); ?>">
       	...
       	<a class="btn btn-outline-primary" href="<?php echo e(route('admin.usersCustomerAction',['edit',$user->id])); ?>">
        ...
        <div class="col-md-7">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.usersCustomerAction',['update',$user->id])); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="media">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 form-group">
                                    <label for="member_card_id" style="color: #ff864a;font-weight: bold;">Membership Card ID</label>
                                    <input type="text" class="form-control <?php echo e($errors->has('address')?'error':''); ?>" name="member_card_id" placeholder="Enter Card ID" value="<?php echo e($user->member_card_id?:old('member_card_id')); ?>" style="border-color: #ff9864;" />
                                    <?php if($errors->has('member_card_id')): ?>
                                    <p style="color: red; margin: 0;"><?php echo e($errors->first('member_card_id')); ?></p>
                                    <?php endif; ?>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/users/customers/editUser.blade.php ENDPATH**/ ?>