   ...
   <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
     <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
       ...
       <a class="btn btn-outline-primary" href="<?php echo e(route('admin.usersCustomer')); ?>">
       	...
       	<a class="btn btn-outline-primary" href="<?php echo e(route('admin.usersCustomerAction',['view',$user->id])); ?>">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Address</th>
                                    <td><?php echo e($user->fullAddress()); ?></td>
                                </tr>
                                <tr>
                                    <th>Status</th>
                                    <td>
                                ...
                                <tr>
                                    <th>Total Sale</th>
                                    <td><?php echo e(priceFullFormat($user->orders->where('order_status','delivered')->whereIn('order_type',['customer_order','pos_order'])->sum('grand_total'))); ?></td>
                                </tr>
                                <tr>
                                    <th>Total Due</th>
                                    <td><?php echo e(priceFullFormat($user->orders->where('order_status','delivered')->whereIn('order_type',['customer_order','pos_order'])->sum('due_amount'))); ?>

                                        
                                        <a href="<?php echo e(route('admin.usersCustomerAction',['view',$user->id,'payment_status'=>'due'])); ?>"><i class="fas fa-external-link-alt"></i></a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($order->order_type=='pos_order'): ?>
                                            <a href="<?php echo e(route('admin.posOrdersAction',['invoice',$order->id])); ?>">
                                            <?php else: ?>
                                            <a href="<?php echo e(route('admin.invoice',$order->id)); ?>">
                                            <?php endif; ?>
                                            
                                            <?php echo e($order->invoice); ?></a></td>
                                        ...
                                        <td>
                                            <?php if($order->order_type=='customer_order'): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/users/customers/viewUser.blade.php ENDPATH**/ ?>