...
<div style="padding:10px;margin: 10px 0;">
    <h2 style="margin: 0;padding: 5px 0;">Welcome to <?php echo e(general()->title); ?>, <?php echo e($datas['name']); ?>! </h2>
    <div>
    <p>Thank you for signing up with <?php echo e(ucfirst(general()->title)); ?>. To complete your forget password, we just need to verify your email address. This ensures that your account is secure</p>
    <p>To activate your account and start exploring thousands of high-quality 
        products please confirm your Verify Code below or click verify button:</p>
    </div>
    <h4 style="text-align:center;">
        <span style="font-size: 24px;">Verify Code: <?php echo e($datas['verifycode']); ?></span>
    </h4>
    <div class="buttonClick" style="text-align: center;">
            <p>
                (Your Verify Code is secret. Can not Share with anyone.)
            </p>
    </div>
    <h3>
    ...
    <ul>
        <li style="padding: 3px 0;">
            <b>Security:</b> Protect your account from unauthorized access.
        </li>
        <li style="padding: 3px 0;">
            <b>Access:</b> Gain full access to all features and content on <?php echo e(general()->title); ?>.
        </li>
        <li style="padding: 3px 0;">
            <b>Updates:</b> Stay informed with our latest additions and promotions.
        </li>
    </ul>
    <p>
        If you didn’t sign up for <?php echo e(general()->title); ?>, please ignore this email, and no further action will be taken.
    </p>
...
<?php /**PATH D:\xampp\htdocs\poshak\resources\views/mails/test.blade.php ENDPATH**/ ?>