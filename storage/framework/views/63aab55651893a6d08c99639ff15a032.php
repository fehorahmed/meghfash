                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 100px;">Parent Brand</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($brand->parent): ?>
                                    <span><?php echo e($brand->parent->name); ?></span>
                                    <?php else: ?>
                                    <span class="badge badge-primary">PARENT Brand</span>
                                    <?php endif; ?>
                                </td>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/brands/brandsAll.blade.php ENDPATH**/ ?>