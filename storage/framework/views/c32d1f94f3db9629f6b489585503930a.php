                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="image">Product Image (Size:- 500X600) </label>
                                ...
                                <div class="form-group">
                                    <label for="gallery_image">Product Gallery (Size:- 500X600)</label>
                                ...
                                <div class="form-group">
                                    <label for="thumbnail">Video thumbnail (Size:- 500X600) </label>
...
<?php echo $__env->make(general()->adminTheme.'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\posher-react-laravel\resources\views/admin/products/productsEdit.blade.php ENDPATH**/ ?>