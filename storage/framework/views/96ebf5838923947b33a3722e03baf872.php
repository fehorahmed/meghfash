...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Transfer invoice</h3>
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.stockTransferAction',['edit',$invoice->id])); ?>"><i class="fa fa-edit"></i> Edit</a>
            <a href="javascript:void(0)" id="PrintAction22" class="btn btn-outline-primary">
                 <i class="bx bx-printer"></i> Print
             </a>
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.stockTransferAction',['invoice',$invoice->id])); ?>">
			...
			<?php echo $__env->make('admin.alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            	<div class="card">
                    <div class="card-header" style="border-bottom: 1px solid #e3ebf3;">
                        <h4 class="card-title">Transfer Invoice</h4>
                    </div>
                         ...
                         <div class="invoice-inner invoicePage PrintAreaContact">
                            <style>
                                    ...
                                    <div class="demo-info">
                                            ...
                                            <h6 style="font-size: 20px;border-top: 1px solid #cccccc;padding-top: 5px;margin:0;font-weight: bold;">TRANSFER INVOICE</h6>
                                    </div>
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-4">
                                        <div class="invoice-info">
                                            <b>From Warehouse</b>: <?php echo e($invoice->formBranch?$invoice->formBranch->name:''); ?><br>
                                            <?php echo e($invoice->formBranch?$invoice->formBranch->description:''); ?><br>
                                            <b>To Warehouse</b>: <?php echo e($invoice->branch?$invoice->branch->name:''); ?><br>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/stock-transfer/transferInvoice.blade.php ENDPATH**/ ?>