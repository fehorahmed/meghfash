...
<?php if($parentOrder =$order->parentOrder): ?>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <img src="<?php echo e(asset($rItem->image())); ?>" style="max-height: 40px;max-width: 100%;">
            </td>
            <td>
            ...
            <td style="padding:5px;">
                <input type="number" value="<?php echo e($rItem->return_quantity); ?>" class="form-control form-control-sm itemUpdate" data-url="<?php echo e(route('admin.ordersReturnAction',['item-quantity',$order->id])); ?>" data-id="<?php echo e($rItem->id); ?>" >
            </td>
...
<?php endif; ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/returns/includes/orderItems.blade.php ENDPATH**/ ?>