                        		...
                        		<div class="col-md-6">
                        			...
                        			<table class="table table-borderless">
		                        		...
		                        		<tr>
		                        			<th>Mobile*</th>
		                        			<td style="padding:3px;">
		                        			    <input type="text" name="mobile" value="<?php echo e($order->mobile); ?>" placeholder="Enter mobile" class="form-control form-control-sm" required="" pattern="^\d{11}$" title="Only 11-digit numbers are allowed">
		                        			</td>
		                        		</tr>
		                        		<tr>
		                        			<th>Email</th>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/orders/ordersManage.blade.php ENDPATH**/ ?>