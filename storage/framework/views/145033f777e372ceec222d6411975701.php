...
<title><?php echo e(websiteTitle('Subscribers')); ?></title>
...
<div class="content-header row">
   ...
   <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
     <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
       	<a class="btn btn-outline-primary" href="<?php echo e(route('admin.subscribes')); ?>">
		...
		<div id="accordion">
			...
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8;border-top: 0;">
				<div class="card-body">
					...
					<form action="<?php echo e(route('admin.subscribes')); ?>">
						<div class="row">
							...
							<div class="col-md-6 mb-1">
								<div class="input-group">
									<input type="text" name="search" value="<?php echo e(request()->search?:''); ?>" placeholder="Subscriber Email" class="form-control <?php echo e($errors->has('search')?'error':''); ?>">
              ...
              <div class="col-md-4">
                 ...
                 <div class="table-responsive">
                     ...
                     <table class="table table-bordered table-striped">
                         ...
                         <tbody>
                         		<?php $__currentLoopData = $subscribes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$subscribe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 <th>
									<input class="checkbox" type="checkbox" name="checkid[]" value="<?php echo e($subscribe->id); ?>">
									<?php echo e($subscribes->currentpage()==1?$i+1:$i+($subscribes->perpage()*($subscribes->currentpage() - 1))+1); ?>

								</th>
                                 <td><?php echo e($subscribe->name); ?></td>
                                 <td><?php echo e($subscribe->created_at->format('d-m-Y')); ?></td>
                             </tr>
                 ...
                 <?php echo e($subscribes->links('pagination')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/users/subscribes/subscribeAll.blade.php ENDPATH**/ ?>