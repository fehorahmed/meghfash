                        ...
                        <div class="row" style="margin:0 -5px;">
                            <div class="col-md-12" style="padding:5px;">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control seachProduct" data-url="<?php echo e(route('admin.posOrdersAction',['productFilter',$invoice->id])); ?>" placeholder="Search Name,Barcode,ID" autocomplete="off">
                                    <div class="input-group-append">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/pos-orders/orderEdit.blade.php ENDPATH**/ ?>