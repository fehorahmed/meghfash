...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.postsCategories')); ?>">BACK</a>
		    <a class="btn btn-outline-primary" href="<?php echo e(route('admin.postsCategoriesAction',['create'])); ?>">Add Category</a>
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.postsCategoriesAction',['edit',$category->id])); ?>">
...
<form action="<?php echo e(route('admin.postsCategoriesAction',['update',$category->id])); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="parent_id" class="form-control">
                                ...
                                <?php if($parent->subctgs->count() > 0): ?> <?php echo $__env->make(adminTheme().'posts.includes.editSubcategory',['subcategories' =>$parent->subctgs, 'i'=>1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php endif; ?> <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label for="fetured">Category Fetured</label>
                                <div class="custom-control custom-checkbox">
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/posts/category/postCategoryEdit.blade.php ENDPATH**/ ?>