...
<title>Store/Branch Reports - <?php echo e(general()->title); ?> | <?php echo e(general()->subtitle); ?></title>
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Store/Branch Reports</h3>
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Dashboard </a></li>
                    <li class="breadcrumb-item active">Store/Branch Reports</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header" style="border-bottom: 1px solid #e3ebf3;">
                        <h4 class="card-title">Store/Branch Reports</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo e(request()->search); ?>" name="search" placeholder="Enter search ID, Barcode">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <select class="form-control" name="branch" required="">
                                            ...
                                            <option value="<?php echo e($warehouse->id); ?>" <?php echo e(request()->branch==$warehouse->id?'selected':''); ?> ><?php echo e($warehouse->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                 ...
                                 <table class="table table-striped table-bordered table-hover dataex-html5-export">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="min-width: 120px;">Store/Branch</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $product->productVariationAttributeItems()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vi=>$variationItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="<?php echo e(asset($variationItem->variationItemImage())); ?>" style="max-width:60px;max-height:30px;">
                                                </td>
                                                <td><?php echo e($product->name); ?> - <?php echo $variationItem->variationItemValues(); ?></td>
                                                <td>
                                                    <?php if($branch =App\Models\Attribute::where('type',5)->where('status','active')->find(request()->branch)): ?>
                                                     <?php echo e($branch->name); ?> 
                                                     <?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php echo e($product->warehouseStores()->where('variant_id', $variationItem->id)->where('quantity','>',0)->where('branch_id',request()->branch)->sum('quantity')); ?>
                                        ...
                                        <tr>
                                            <td><?php echo e($i+1); ?></td>
                                            <td><img src="<?php echo e(asset($product->image())); ?>" style="max-width:60px;max-height:30px;" ></td>
                                            ...
                                            <td>
                                                <?php echo e($product->warehouseStores()->where('quantity','>',0)->where('branch_id',request()->branch)->sum('quantity')); ?>
                            ...
                            <h3 style="text-align: center;font-size: 24px;color: #cac2c2;">Select your Store/Branch</h3>
...
<script type="text/javascript">
    $(document).ready(function () {
            $(".dataex-html5-export").DataTable({ dom: "Bfrtip", buttons: ["copyHtml5", "excelHtml5", "csvHtml5", "pdfHtml5", "print"],pageLength: 100 }),
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/reports/storeBranchReports.blade.php ENDPATH**/ ?>