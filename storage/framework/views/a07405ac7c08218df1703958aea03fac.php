                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                            ...
                            <select name="sms_type" class="form-control <?php echo e($errors->has('sms_type')?'error':''); ?>">
                                <option value="smtp" <?php echo e($general->sms_type=='Non Masking'?'selected':''); ?>>Non-Masking</option>
                                <option value="mailgun" <?php echo e($general->sms_type=='Masking'?'selected':''); ?>>Masking</option>
                            </select>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\poshak\resources\views/admin/setting/sms.blade.php ENDPATH**/ ?>