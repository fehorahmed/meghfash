<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            <label>From Store/Branch*</label>
            <?php if($invoice->items()->count() > 0): ?>
            <input type="text" readonly value="<?php echo e($invoice->formBranch?$invoice->formBranch->name:''); ?>" class="form-control">
            <?php else: ?>
            <select class="form-control selectWarehouse2"  data-url="<?php echo e(route('admin.stockTransferAction',['formwarehouse-select',$invoice->id])); ?>">
                <option value="">Select Store/Branch</option>
                <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($warehouse->id); ?>" <?php echo e($warehouse->id==$invoice->user_id?'selected':''); ?>><?php echo e($warehouse->name); ?></option>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>To Store/Branch*</label>
            <?php if($invoice->items()->count() > 0): ?>
            <input type="text" readonly value="<?php echo e($invoice->branch?$invoice->branch->name:''); ?>" class="form-control">
            <?php else: ?>
            <select class="form-control selectWarehouse"  data-url="<?php echo e(route('admin.stockTransferAction',['towarehouse-select',$invoice->id])); ?>">
                <option value="">Select Store/Branch</option>
                <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/stock-transfer/includes/transferInformation.blade.php ENDPATH**/ ?>