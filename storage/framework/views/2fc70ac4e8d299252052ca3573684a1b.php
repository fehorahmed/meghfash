                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e(priceFullFormat($pOrder->grand_total-$pOrder->shipping_charge)); ?></td>
                                                    <td><?php echo e(priceFullFormat($pOrder->shipping_charge)); ?></td>
                                                    <td><?php echo e($pOrder->name); ?></td>
                                                    <td><?php echo e($pOrder->created_at->format('d-m-Y')); ?></td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td></td>
                                                    <td><?php echo e(priceFullFormat($customerOrders->sum('grand_total')-$customerOrders->sum('shipping_charge'))); ?></td>
                                                    <td><?php echo e(priceFullFormat($customerOrders->sum('shipping_charge'))); ?></td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                            </tbody>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/reports/summeryReports.blade.php ENDPATH**/ ?>