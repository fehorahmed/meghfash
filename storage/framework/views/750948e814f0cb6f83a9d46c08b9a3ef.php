...
<div class="table-responsive">                 
		<table class="table table-bordered">
			...
			<tr>
				<td><?php echo e(++$i); ?></td>
				<td><img src="<?php echo e(asset($item->image())); ?>" style="max-height: 40px;max-width: 100%;"></td>
				<td>
				...
				<td style="padding:3px;">
					...
					data-url="<?php echo e(route('admin.wholeSalesAction',['item-quantity',$invoice->id])); ?>"
				...
				<td style="padding:3px;">
					...
					data-url="<?php echo e(route('admin.wholeSalesAction',['item-price',$invoice->id])); ?>"
				...
				<td style="text-align: center;">
    				<span class="badge badge-danger itemRemove" data-url="<?php echo e(route('admin.wholeSalesAction',['remove-item',$invoice->id])); ?>" data-id="<?php echo e($item->id); ?>" style="cursor:pointer;"> <i class="fa fa-trash"></i> </span>
				</td>
			</tr>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	...
	<div class="row">
		...
		<div class="col-md-4">
		    <div class="form-group mb-1">
    		        ...
    		        <input type="number" class="form-control itemUpdatePurchase" value="<?php echo e($invoice->adjustment_amount); ?>" placeholder="Amount" data-id="0" data-url="<?php echo e(route('admin.wholeSalesAction',['adjustment-amount',$invoice->id])); ?>" >
    		</div>
	...
	</div><?php /**PATH /home/meghfash/public_html/resources/views/admin/wholesale/includes/orderItems.blade.php ENDPATH**/ ?>