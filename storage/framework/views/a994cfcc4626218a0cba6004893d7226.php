                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="todaySummery">
                                <h4>Today Summery</h4>
                                <ul>
                                    <li><b>Total Sale</b>: <?php echo e(priceFullFormat($reports['todaySale']+$reports['posSale']+$reports['todayWholesale'])); ?> </li>
                                    <li><b>Online Sale</b>: <?php echo e(priceFullFormat($reports['todaySale'])); ?> </li>
                                    <li><b>POS Sale</b>:  <?php echo e(priceFullFormat($reports['posSale'])); ?></li>
                                    <li><b>Wholesale</b>: <?php echo e(priceFullFormat($reports['todayWholesale'])); ?> </li>
                                    <li><b>Expense</b>: <?php echo e(priceFullFormat($reports['todayExpense'])); ?> </li>
                                    <li><b>Stock Purchase</b>: <?php echo e(priceFullFormat($reports['todayStockPurchase'])); ?> </li>
                                    <li><b>Return Sale</b>: <?php echo e(priceFullFormat($reports['todayReturnSale'])); ?> </li>
                                    <li><b>Wholesale Return</b>: <?php echo e(priceFullFormat($reports['todayStockPurchase'])); ?> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="todaySummery">
                                ...
                                <ul>
                                    <li><b>Total Product Stock</b>: <?php echo e(number_format($reports['totalItems'])); ?> Items (<?php echo e(number_format($reports['totalStock'])); ?> Qty) </li>
                                    <li><b>Today Stock In</b>: <?php echo e(number_format($reports['todayStockInItem'])); ?> Items (<?php echo e(number_format($reports['todayStockIn'])); ?> Qty) </li>
                                    <li><b>Today Stock Out</b>:  <?php echo e(number_format($reports['todayStockSaleItem'])); ?> Items (<?php echo e(number_format($reports['todayStockSale'])); ?> Qty)</li>
                                    <li><b>Stock Out Product</b>: <?php echo e(number_format($reports['totalStockOutItem'])); ?> Items </li>
                                    <li><b>Low Stock Product</b>: <?php echo e(number_format($reports['totalLowStockOutItem'])); ?> Items </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="todaySummery">
                                ...
                                <ul>
                                    <li><b>Total Due</b>: <?php echo e(priceFullFormat($reports['totalDueSale'])); ?> </li>
                                    <li><b>Total Customer</b>:  <?php echo e(number_format($reports['customer'])); ?> </li>
                                    <li><b>Total Admin</b>: <?php echo e(number_format($reports['admin'])); ?> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>