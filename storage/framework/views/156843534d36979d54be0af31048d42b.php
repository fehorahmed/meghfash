<ul>
    ...
    <li><span class="selectCustomer" style="cursor:pointer;" data-url="<?php echo e(route('admin.posOrdersAction',['selectCustomer',$invoice->id,'customer_id'=>$customer->id])); ?>"><?php echo e($customer->name?:'Unkown'); ?> - <?php echo e($customer->mobile?:$customer->email); ?></span></li>
    ...
    <?php endif; ?>
</ul><?php /**PATH C:\xampp\htdocs\posher-react-laravel\resources\views/admin/pos-orders/includes/searchCustomers.blade.php ENDPATH**/ ?>