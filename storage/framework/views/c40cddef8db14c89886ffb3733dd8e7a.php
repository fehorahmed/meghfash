...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.wholesaleReturn')); ?>">Back</a>
            
            <?php if(isset(json_decode(Auth::user()->permission->permission, true)['orders']['manage'])): ?>
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.wholesaleReturnAction',['edit',$order->id])); ?>">Edit</a>
            <?php endif; ?>
            <button class="btn btn-success" id="PrintAction" ><i class="fa fa-print"></i> Print</button>

            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.wholesaleReturnAction',['invoice',$order->id])); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/returns/wholesaleReturnInvoice.blade.php ENDPATH**/ ?>