                ...
                <div class="varitaionItemproduct">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" class="form-control" name="variation_quantity" value="<?php echo e($product->quantity); ?>" placeholder="Quantity">
                        </div>
                        <div class="col-md-4 form-group">
            ...
            <div class="modal-body">
                <div class="varitaionItemproduct_<?php echo e($itemEdit->id); ?>">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            <label>Quantity</label>
                            <input type="number" class="form-control" name="variation_quantity" value="<?php echo e($itemEdit->quantity); ?>" placeholder="Quantity">
                        </div>
                        <div class="col-md-4 form-group">
                            <label>Stock Status</label>
                            <select class="form-control" name="variation_stock">
...
</div><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/products/includes/productsDataAttributes2.blade.php ENDPATH**/ ?>