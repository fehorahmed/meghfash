 <!-- BEGIN: Main Menu-->
   <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
     <div class="main-menu-content">
       <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item <?php echo e(Request::is('admin/suppliers*')? 'active' : ''); ?>"><a href="<?php echo e(route('admin.usersSupplier')); ?>"><i class="fas fa-user"></i><span class="menu-title">Suppliers</span></a></li>
         <?php endif; ?>
        
        <?php if(isset(json_decode($roles->permission, true)['warehouse']['list'])): ?>
        <li class=" nav-item <?php echo e(Request::is('admin/warehouses*')? 'active' : ''); ?>"><a href="<?php echo e(route('admin.productsWarehouses')); ?>"><i class="fas fa-home"></i><span class="menu-title">Store/Branch</span></a></li>
        <li class=" nav-item <?php echo e(Request::is('admin/stock-transfer*')? 'active' : ''); ?>"><a href="<?php echo e(route('admin.stockTransfer')); ?>"><i class="fas fa-truck"></i><span class="menu-title">Stock Transfer</span></a></li>
         <?php endif; ?>
        
        <?php if(isset(json_decode($roles->permission, true)['stockManage']['list'])): ?>
        <li class=" nav-item <?php echo e(Request::is('admin/stock-management*')? 'active' : ''); ?>"><a href="<?php echo e(route('admin.purchases')); ?>"><i class="fas fa-truck"></i><span class="menu-title">Stock Management</span></a></li>
        <?php endif; ?>
        
        <?php if(isset(json_decode($roles->permission, true)['stockManage']['report'])): ?>
        <li class=" nav-item <?php echo e(Request::is('admin/stock-report*')? 'active' : ''); ?>"><a href="<?php echo e(route('admin.stocksList')); ?>"><i class="fas fa-chart-line"></i><span class="menu-title">Stock Reports</span></a></li>
        <?php endif; ?>
        
        <?php if(isset(json_decode($roles->permission, true)['paymentMethod']['list'])): ?>
        <li class=" nav-item <?php echo e(Request::is('admin/payment-method*')? 'active' : ''); ?>"><a href="<?php echo e(route('admin.paymentMethods')); ?>"><i class="fas fa-money"></i><span class="menu-title">Payment Methods</span></a></li>
         <?php endif; ?>
        ...
        isset(json_decode($roles->permission, true)['adminUsers']['list']) ||  
         ...
         <li class=" nav-item <?php echo e(Request::is('admin/users/wholesale-customer*')? 'active' : ''); ?>">
          <a href="<?php echo e(route('admin.usersWholesaleCustomer')); ?>"><i class="fas fa-users"></i><span class="menu-title" >Wholesale Customer </span></a>
         </li>
         <?php endif; ?>
   ...
   <!-- END: Main Menu--><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>