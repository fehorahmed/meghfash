...
<title><?php echo e(websiteTitle('Suppllier Users')); ?></title>
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Suppllier Users</h3>
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Dashboard </a></li>
                    <li class="breadcrumb-item active">Suppllier Users</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#AddUser">Add Suppllier</button>
            <?php endif; ?>
    ...
    <div class="card-content">
        <div id="accordion">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.usersSupplier')); ?>">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-1">
                                <div class="input-group">
                                    <input type="text" name="search" value="<?php echo e(request()->search?:''); ?>" placeholder="Suppllier Name, Email, Mobile" class="form-control <?php echo e($errors->has('search')?'error':''); ?>" />
...
<div class="card">
    <div class="card-header" style="border-bottom: 1px solid #e3ebf3;">
        <h4 class="card-title">Suppllier users List</h4>
    </div>
    <div class="card-content">
        <div class="card-body">
        <form action="<?php echo e(route('admin.usersSupplier')); ?>">
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="statuslist">
                        <li><a href="<?php echo e(route('admin.usersSupplier')); ?>">All (<?php echo e($totals->total); ?>)</a></li>
                        <li><a href="<?php echo e(route('admin.usersSupplier',['status'=>'active'])); ?>">Active (<?php echo e($totals->active); ?>)</a></li>
                        <li><a href="<?php echo e(route('admin.usersSupplier',['status'=>'inactive'])); ?>">Inactive (<?php echo e($totals->inactive); ?>)</a></li>
                    </ul>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('admin.usersSupplierAction',['edit',$user->id])); ?>" class="invoice-action-view mr-1"><?php echo e($user->name); ?></a></td>
                            ...
                            <td style="padding:0; text-align: center;">
                                <a href="<?php echo e(route('admin.usersSupplierAction',['edit',$user->id])); ?>" class="btn btn-md btn-info">
                                    <i class="fa fa-edit"></i> Edit
                                </a>

                                <?php if($user->id==Auth::id()): ?> <?php else: ?>
                                <a href="<?php echo e(route('admin.usersSupplierAction',['delete',$user->id])); ?>" onclick="return confirm('Are You Want To Delete')" class="btn btn-md btn-danger">
 ...
 <div class="modal fade text-left" id="AddUser" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
	 <div class="modal-content">
	 	<form action="<?php echo e(route('admin.usersSupplierAction','create')); ?>" method="post">
	   		<?php echo csrf_field(); ?>
	   ...
	   <div class="modal-body">
			 ...
			 <div class="form-group">
				...
				<input type="email" class="form-control <?php echo e($errors->has('email_mobile')?'error':''); ?>" name="email_mobile" placeholder="Enter Email" required="">
				<?php if($errors->has('email_mobile')): ?>
				<p style="color: red; margin: 0; font-size: 10px;"><?php echo e($errors->first('email_mobile')); ?></p>
				<?php endif; ?>
         	</div>
	   </div>
	   <div class="modal-footer">
		 <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close </button>
		 <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Add Suppllier</button>
	   </div>
	   </form>
	 </div>
   </div>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/users/suppliers/users.blade.php ENDPATH**/ ?>