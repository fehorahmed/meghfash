...
<div class="row">
	...
	<div class="form-group col-md-4">
		...
		class="form-control productDataAjaxUpdate form-control-sm <?php echo e($errors->has('purchase_price')?'error':''); ?>"
	        ...
	        <table class="table table-bordered">
	            ...
	            <tr>
	                <td>
                		...
                		value="<?php echo e($product->warranty_note?$product->warranty_note:old('warranty_note')); ?>" 
                		data-url="<?php echo e(route('admin.productsUpdateAjax',['warranty_note',$product->id])); ?>" 
                		class="form-control productDataAjaxUpdate form-control-sm <?php echo e($errors->has('warranty_note')?'error':''); ?>" 
                
                		placeholder="Enter Warranty">
	                </td>
	                <td>
	                    <input type="number" name="warranty_charge" 
                		value="<?php echo e($product->warranty_charge?$product->warranty_charge:old('warranty_charge')); ?>" 
                		data-url="<?php echo e(route('admin.productsUpdateAjax',['warranty_charge',$product->id])); ?>" 
                		class="form-control productDataAjaxUpdate form-control-sm <?php echo e($errors->has('warranty_charge')?'error':''); ?>" 
	            ...
	            <tr>
	                <td>
                		...
                		value="<?php echo e($product->warranty_note2?$product->warranty_note2:old('warranty_note2')); ?>" 
                		data-url="<?php echo e(route('admin.productsUpdateAjax',['warranty_note2',$product->id])); ?>" 
                		class="form-control productDataAjaxUpdate form-control-sm <?php echo e($errors->has('warranty_note2')?'error':''); ?>" 
                
                		placeholder="Enter Warranty">
	                </td>
	                <td>
	                    <input type="number" name="warranty_charge2" 
                		value="<?php echo e($product->warranty_charge2?$product->warranty_charge2:old('warranty_charge2')); ?>" 
                		data-url="<?php echo e(route('admin.productsUpdateAjax',['warranty_charge2',$product->id])); ?>" 
                		class="form-control productDataAjaxUpdate form-control-sm <?php echo e($errors->has('warranty_charge2')?'error':''); ?>" 
...
<?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/products/includes/productsDataGeneral.blade.php ENDPATH**/ ?>