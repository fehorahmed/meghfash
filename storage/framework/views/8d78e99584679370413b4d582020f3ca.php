        ...
        <div class="form-group">
            ...
            <div class="searchCustomer">
                <div class="input-group">
                    <input type="text" placeholder="Search Customer" value="<?php if($invoice->name || $invoice->mobile): ?><?php echo e($invoice->name); ?> <?php echo e($invoice->mobile); ?><?php endif; ?>" data-url="<?php echo e(route('admin.posOrdersAction',['searchCustomer',$invoice->id])); ?>" class="form-control form-control-sm">
...
<div class="totalInfo">
    ...
    <div class="SaleInfo">
        ...
        <div  class="row">
            <div class="col-md-6">
                <button class="btn btn-block btn-success" data-toggle="modal" data-target="#PaymentAmount" <?php echo e($invoice->items()->count()==0?'disabled':''); ?> >Pay Now</button>
            </div>
            <div class="col-md-3">
...
<div class="modal fade text-left" id="PaymentAmount" tabindex="-1" role="dialog">
 ...
 <!-- Customer Add  Modal -->
<div class="modal fade text-left" id="CustomerModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
    	   <div class="modal-header" style="padding: 5px 10px;background: #17a2b8;">
    		 <h4 class="modal-title" style="font-size: 20px;color: white;">New Customer</h4>
    		 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    		   <span aria-hidden="true">&times; </span>
    		 </button>
    	   </div>
    	   <div class="modal-body NewCustomerBody">
...
<div class="modal fade text-left" id="TaxAmount" tabindex="-1" role="dialog">
 ...
 </div><?php /**PATH C:\xampp\htdocs\posher-react-laravel\resources\views/admin/pos-orders/includes/shoppingCart.blade.php ENDPATH**/ ?>