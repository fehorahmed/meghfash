<!-- Modal -->
				...
				<div class="tab-pane active" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
    				<form action="<?php echo e(route('admin.ordersAction',['payment',$order->id])); ?>" method="post">
    					...
    					<div class="form-group">
    					    ...
    					    <input type="date" value="<?php echo e($order->created_at->format('Y-m-d')); ?>" class="form-control" name="created_at">
    					</div>
    					<div class="form-group">
    						<label>Amount</label>
 ...
 </div><?php /**PATH /home/meghfash/public_html/resources/views/admin/orders/includes/paymentModal.blade.php ENDPATH**/ ?>