...
<title><?php echo e(websiteTitle('Wholesale Customers')); ?></title>
    ...
    <div class="card-content">
        <div id="accordion">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.usersWholesaleCustomer')); ?>">
                        <div class="row">
    ...
    <div class="card-content">
        ...
        <form action="<?php echo e(route('admin.usersWholesaleCustomer')); ?>">
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="statuslist">
                        <li><a href="<?php echo e(route('admin.usersWholesaleCustomer')); ?>">All (<?php echo e($totals->total); ?>)</a></li>
                        <li><a href="<?php echo e(route('admin.usersWholesaleCustomer',['status'=>'active'])); ?>">Active (<?php echo e($totals->active); ?>)</a></li>
                        <li><a href="<?php echo e(route('admin.usersWholesaleCustomer',['status'=>'inactive'])); ?>">Inactive (<?php echo e($totals->inactive); ?>)</a></li>
                    </ul>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.usersWholesaleCustomerAction',['view',$user->id])); ?>" class="invoice-action-view mr-1"><?php echo e($user->company_name); ?></a>
                            </td>
                            <td>
                            ...
                            <td><?php echo e(priceFullFormat($user->orders->where('order_status','delivered')->where('order_type','wholesale_order')->sum('due_amount'))); ?></td>
                            <td>
                                <?php if($user->status): ?>
                            ...
                            <td style="padding:0; text-align: center;">
                                <a href="<?php echo e(route('admin.usersWholesaleCustomerAction',['edit',$user->id])); ?>" class="btn btn-md btn-info">
                                ...
                                <a href="<?php echo e(route('admin.usersWholesaleCustomerAction',['delete',$user->id])); ?>" onclick="return confirm('Are You Want To Delete')" class="btn btn-md btn-danger">
 ...
 <div class="modal fade text-left" id="AddUser" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
	 <div class="modal-content">
	 	<form action="<?php echo e(route('admin.usersWholesaleCustomerAction','create')); ?>" method="post">
	   		<?php echo csrf_field(); ?>
	   ...
	   <div class="modal-body">
	   		<div class="form-group">
                ...
                <input type="text" class="form-control <?php echo e($errors->has('company_name')?'error':''); ?>" name="company_name" placeholder="Enter Company" required="">
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/users/wholesale-customers/users.blade.php ENDPATH**/ ?>