...
<title><?php echo e(websiteTitle('Post Categories')); ?></title>
...
<div class="content-header row">
   ...
   <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
     <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
       	...
       	<a class="btn btn-outline-primary" href="<?php echo e(route('admin.postsCategoriesAction','create')); ?>">Add Category</a>
       	<a class="btn btn-outline-primary" href="<?php echo e(route('admin.postsCategories')); ?>">
 					 ...
 					 <div id="accordion">
					    ...
					    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8;border-top: 0;">
					      <div class="card-body">
					       	...
					       	<form action="<?php echo e(route('admin.postsCategories')); ?>">
							       		<div class="row">
							       			<div class="col-md-12 mb-0">
							       					<div class="input-group">
                     		<input type="text" name="search" value="<?php echo e(request()->search?request()->search:''); ?>" placeholder="Category Name" class="form-control <?php echo e($errors->has('search')?'error':''); ?>">
             ...
             <table class="table table-striped table-bordered table-hover" >
		                              ...
		                              <input class="checkbox" type="checkbox" class="form-control" id="checkall">  All <span class="checkCounter"></span>
											    ...
											    <tbody>
											        ...
											        <tr>
											            <td>
											            <input class="checkbox" type="checkbox" name="checkid[]" value="<?php echo e($category->id); ?>"><br><?php echo e($i+1); ?>

											            </td>
											            <td>
											            <a href="<?php echo e(route('blogCategory',$category->slug?:'no-title')); ?>" target="_blank"><?php echo e($category->name); ?></a><br>
											           ...
											           <span style="font-size: 10px;"><i class="fa fa-user" style="color: #1ab394;"></i>
											            ...
											            <span style="font-size: 10px;"><i class="fa fa-calendar" style="color: #1ab394;"></i> <?php echo e($category->created_at->format('d-m-Y')); ?></span>
											            </td>
											            <td>
											            ...
											            <td class="center">
											            <a href="<?php echo e(route('admin.postsCategoriesAction',['edit',$category->id])); ?>" class="btn btn-md btn-info">Edit</a>
											            
											            
											            <a href="<?php echo e(route('admin.postsCategoriesAction',['delete',$category->id])); ?>" onclick="return confirm('Are You Want to Delete?')" class="btn btn-md btn-danger" ><i class="fa fa-trash"></i></a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(general()->adminTheme.'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/posts/category/postsCategories.blade.php ENDPATH**/ ?>