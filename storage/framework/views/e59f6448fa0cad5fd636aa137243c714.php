...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="<?php echo e(route('admin.purchasesAction',['edit',$invoice->id])); ?>"><i class="fa fa-list"></i> Edit</a>
                            ...
                            <style>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                            ...
                                            <b>Created By:</b> <?php echo e($invoice->soldBy?$invoice->soldBy->name:''); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/purchases/purchasesInvoice.blade.php ENDPATH**/ ?>