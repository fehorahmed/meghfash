...
<?php if($parentOrder =$order->parentOrder): ?>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><img src="<?php echo e(asset($rItem->image())); ?>" style="max-height: 40px;max-width: 100%;"></td>
            <td>
...
<?php endif; ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/returns/includes/wholesaleOrderItems.blade.php ENDPATH**/ ?>