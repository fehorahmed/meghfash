                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.usersCustomer')); ?>">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-1">
                                <div class="input-group">
                                    <input type="text" name="search" value="<?php echo e(request()->search?:''); ?>" placeholder="User Name, Email, Mobile" class="form-control <?php echo e($errors->has('search')?'error':''); ?>" />
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('admin.usersCustomerAction',['edit',$user->id])); ?>" class="invoice-action-view mr-1"><?php echo e($user->name); ?></a></td>
                            ...
                            <td style="padding:0; text-align: center;">
                                ...
                                <?php if(isset(json_decode(Auth::user()->permission->permission, true)['users']['delete'])): ?> <?php if($user->id==Auth::id()): ?> <?php else: ?>
	 ...
	 <div class="modal-content">
	   ...
	   <div class="modal-body">
			 ...
			 <div class="form-group">
				...
				<input type="email" class="form-control <?php echo e($errors->has('email')?'error':''); ?>" name="email" placeholder="Enter Email" required="">
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/users/customers/users.blade.php ENDPATH**/ ?>