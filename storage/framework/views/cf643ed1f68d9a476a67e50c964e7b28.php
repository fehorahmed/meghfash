...
<title><?php echo e(websiteTitle('Coupons List')); ?></title>
...
<div class="card-content">
        <div id="accordion">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.ecommerceCoupons')); ?>">
                        <div class="row">
                            <div class="col-md-12 mb-0">
                                <div class="input-group">
                                    <input type="text" name="search" value="<?php echo e(request()->search?request()->search:''); ?>" placeholder="Coupon Code" class="form-control <?php echo e($errors->has('search')?'error':''); ?>" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($coupon->start_date && $coupon->end_date): ?>
                                ...
                                <?php if(Carbon\Carbon::now() < carbon\carbon::parse($coupon->end_date)): ?>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.ecommerceCouponsAction',['edit',$coupon->id])); ?>" class="badge badge-success" ><i class="fa fa-edit"></i></a>
                            <a href="<?php echo e(route('admin.ecommerceCouponsAction',['delete',$coupon->id])); ?>" class="badge badge-danger" onclick="return confirm('Are You Want To Delete?')"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/ecommerce-setting/coupons/couponsAll.blade.php ENDPATH**/ ?>