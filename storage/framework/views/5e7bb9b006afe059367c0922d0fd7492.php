                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <input type="number" name="discount" value="<?php echo e($promotion->amounts>0?$promotion->amounts:''); ?>" class="form-control form-control-sm" placeholder="Discount" required="">
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\posher-react-laravel\resources\views/admin/ecommerce-setting/promotions/promotionsEdit.blade.php ENDPATH**/ ?>