                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td style="padding: 2px;">
                                    <input type="text" name="patho_store_id" value="<?php echo e($general->patho_store_id); ?>" placeholder="Store ID" class="form-control <?php echo e($errors->has('patho_store_id')?'error':''); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Client ID</th>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/setting/general.blade.php ENDPATH**/ ?>