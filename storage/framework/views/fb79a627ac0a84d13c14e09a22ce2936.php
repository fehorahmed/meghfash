                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="for_website" name="for_website" <?php echo e($product->for_website?'checked':''); ?>/>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="top_sale" name="top_sale" <?php echo e($product->top_sale?'checked':''); ?>/>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="sale_label" name="sale_label" <?php echo e($product->sale_label?'checked':''); ?>/>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="import_status" name="import_status" <?php echo e($product->import_status?'checked':''); ?>/>
                                            <label class="custom-control-label" for="import_status">Yes <small>(Include Vat <?php echo e(general()->import_tax); ?>%)</small></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php echo e($errors->has('video_link')?'error':''); ?>" name="video_link" placeholder="Enter video link" value="<?php echo e($product->video_link?:old('video_link')); ?>" />
                                    <?php if($errors->has('video_link')): ?>
                                    <p style="color: red; margin: 0; font-size: 10px;"><?php echo e($errors->first('video_link')); ?></p>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group">
                                    <label for="thumbnail">Video thumbnail (Size:- 1040X1300) </label>
                                    <input type="file" name="thumbnail" class="form-control <?php echo e($errors->has('thumbnail')?'error':''); ?>" />
                                    <?php if($errors->has('thumbnail')): ?>
                                    <p style="color: red; margin: 0; font-size: 10px;"><?php echo e($errors->first('thumbnail')); ?></p>
                                    <?php endif; ?>
                                </div>
                                <?php if($product->bannerFile): ?>
                                <div class="form-group">
                                    <img src="<?php echo e(asset($product->banner())); ?>" style="max-width: 100px;" />
                                    <?php if(isset(json_decode(Auth::user()->permission->permission, true)['products']['add'])): ?>
                                    <a href="<?php echo e(route('admin.mediesDelete',$product->bannerFile->id)); ?>" class="mediaDelete" style="color: red;"><i class="fa fa-trash"></i></a>
                                    <?php endif; ?>
                                </div>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make(general()->adminTheme.'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\posher-react-laravel\resources\views/admin/products/productsEdit.blade.php ENDPATH**/ ?>