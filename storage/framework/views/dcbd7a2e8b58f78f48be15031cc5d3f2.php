...
<div class="table-responsive">                 
		<table class="table table-bordered">
			...
			<tr>
				...
				<td style="padding:3px;">
					...
					data-url="<?php echo e(route('admin.stockTransferAction',['item-quantity',$invoice->id])); ?>"
				...
				<td style="padding:3px;">
					...
					data-url="<?php echo e(route('admin.stockTransferAction',['item-price',$invoice->id])); ?>"
				...
				<td style="text-align: center;">
    				<span class="badge badge-danger itemRemove" data-url="<?php echo e(route('admin.stockTransferAction',['remove-item',$invoice->id])); ?>" data-id="<?php echo e($item->id); ?>" style="cursor:pointer;"> <i class="fa fa-trash"></i> </span>
				</td>
			</tr>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	...
	</div><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/stock-transfer/includes/purchaseItems.blade.php ENDPATH**/ ?>