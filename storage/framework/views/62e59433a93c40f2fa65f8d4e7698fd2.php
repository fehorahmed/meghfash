                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.posOrders')); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    <div class="input-group">
                                        <input type="text" name="search" value="<?php echo e(request()->search?:''); ?>" placeholder="Invoice no, Customer Mobile, email" class="form-control <?php echo e($errors->has('search')?'error':''); ?>" />
...
<div class="card">
    ...
    <div class="card-content">
        <div class="card-body">
            ...
            <!--                    <?php if(isset(json_decode(Auth::user()->permission->permission, true)['posUrders']['manage'])): ?>-->
            <!--                    <option value="1">Pending</option>-->
            <!--                    <option value="4">Delivered</option>-->
            <!--                    <option value="5">Cancelled</option>-->
            <!--                    <?php endif; ?>-->
                                <!--<?php if(isset(json_decode(Auth::user()->permission->permission, true)['posUrders']['delete'])): ?>-->
                ...
                <table class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('admin.posOrdersAction',['invoice',$order->id])); ?>" target="_blank"><?php echo e($order->invoice); ?></a></td>
                                ...
                                <td>
                                    ...
                                    <?php if($order->payment_status=='parftial'): ?>
                                    <span class="badge badge-success" style="background:#ff9800;"><?php echo e(ucfirst('Paid')); ?></span>
                                    <?php elseif($order->payment_status=='paid' || $order->payment_status=='partial'): ?>
                                    <span class="badge badge-success" style="background:#673ab7;"><?php echo e(ucfirst('Paid')); ?></span>
                                    <?php else: ?>
                                ...
                                <td>
                                    ...
                                    <!--<a href="<?php echo e(route('admin.posOrdersAction',['exchange',$order->id])); ?>" class="btn btn-sm btn-info">Exchange</a>-->
                                    <?php else: ?>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/pos-orders/ordersAll.blade.php ENDPATH**/ ?>