                        ...
                        <tbody>
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(priceFormat($invoice->grand_total)); ?></td>
                                    <td><?php echo e(ucfirst($invoice->order_status)); ?></td>
                                    <td><?php echo e($invoice->created_at->format('d.m.Y')); ?></td>
                                    <td><?php echo e($invoice->soldBy?$invoice->soldBy->name:''); ?></td>
                                </tr>
...
<?php echo $__env->make(general()->adminTheme.'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/public_html/resources/views/admin/purchases/purchasesAll.blade.php ENDPATH**/ ?>