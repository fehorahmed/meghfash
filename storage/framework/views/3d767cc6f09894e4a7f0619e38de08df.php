...
<title><?php echo e(websiteTitle('Galleries List')); ?></title>
...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
          ...
          <?php endif; ?>
            <a class="btn btn-outline-primary reloadPage1" href="<?php echo e(route('admin.galleries')); ?>">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span style="color:#ccc;">(<?php echo e($gallery->location); ?>)</span>
                                                <?php endif; ?>
                                                <br />
                                                ...
                                                <?php endif; ?> <?php if($gallery->fetured==true): ?>
                                                <span><i class="fa fa-star" style="color: #1ab394;"></i></span>
                                                <?php endif; ?>
                                                <span style="font-size: 10px;">
                                                    <i class="fa fa-user" style="color: #1ab394;"></i>
                                                    <?php echo e($gallery->user?$gallery->user->name:'No Author'); ?>

                                                </span>
                                            </td>
                                            <td style="text-align: center;">
                                                (<?php echo e($gallery->galleryImages->count()); ?>) Images
                                            </td>
                                            <td class="center">
                                                <a href="<?php echo e(route('admin.galleriesAction',['edit',$gallery->id])); ?>" class="btn btn-md btn-info">Config</a>

                                                <?php if(isset(json_decode(Auth::user()->permission->permission, true)['galleries']['delete'])): ?>
                                                <a href="<?php echo e(route('admin.galleriesAction',['delete',$gallery->id])); ?>" class="btn btn-md btn-danger" onclick="return confirm('Are You Want To Delete?')"><i class="fa fa-trash"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                ...
                                <?php echo e($galleries->links('pagination')); ?>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/posher.com.bd/resources/views/admin/galleries/galleriesAll.blade.php ENDPATH**/ ?>