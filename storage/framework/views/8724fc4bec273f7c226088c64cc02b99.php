                            ...
                            <div class="invoiceBody top">
                                <table class="table" style="min-width:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center"><?php echo e(priceFormat($item->regular_price)); ?></td>
                                        <!--<td style="text-align: center"><?php echo e(priceFormat($item->tax_amount)); ?>-->
                                        <!--(<?php echo e((float) $item->tax); ?>%)-->
                                        <!--</td>-->
                                        <td style="text-align:end;"><?php echo e(priceFormat($item->quantity*$item->regular_price)); ?></td>
                                    </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/posherbd/public_html/resources/views/admin/pos-orders/orderPosInvoice.blade.php ENDPATH**/ ?>