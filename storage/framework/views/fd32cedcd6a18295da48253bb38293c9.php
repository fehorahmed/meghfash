			...
			<?php echo $__env->make('admin.alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            	<div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?php echo e(route('admin.purchasesAction',['update',$invoice->id])); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                            <div class="updateForm">
                            
                                <div class="orderInformation">
                                    <?php echo $__env->make(adminTheme().'purchases.includes.purchaseInformation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-5" style="padding:15px;">
                                        <div class="SearchContain">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control serchProducts" data-url="<?php echo e(route('admin.purchasesAction',['search-product',$invoice->id])); ?>" placeholder="Search Product Name" autocomplete="off">
                                            </div>
                                            <div class="searchResultlist">
                                                <?php echo $__env->make(adminTheme().'purchases.includes.searchResult', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-4" style="padding:15px;">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control serchBarcodeProdut" data-url="<?php echo e(route('admin.purchasesAction',['search-barcode-product',$invoice->id])); ?>" placeholder="Search Product Barcode" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="purchaseItemsSection">
                    	            ...
                    	            <?php echo $__env->make(adminTheme().'purchases.includes.purchaseItems', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\posher-react-laravel\resources\views/admin/purchases/purchasesEdit.blade.php ENDPATH**/ ?>