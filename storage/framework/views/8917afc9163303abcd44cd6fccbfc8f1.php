                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <style type="text/css">
                            ...
                            .top .table-bordered, .table-bordered td, .table-bordered th {
                                border: 1px dashed #979ead;
                            }
                            ...
                            <div class="invoiceHead">
                            <img src="<?php echo e(asset(general()->logo())); ?>" style="max-height: 100px;max-width: 100%; margin-bottom: 5px;">
                                <!--<h1 style="text-transform: uppercase;">Posher Lifestyle</h1>-->
                                <p>
                                    <span style="margin-bottom: 10px"><?php echo e(general()->address_one); ?></span>
                                    <span style="margin-bottom: 10px"><b>Help Line : </b><?php echo e(general()->email); ?>, <?php echo e(general()->mobile); ?> </span>
                            ...
                            <div style="display: flex;  align-items: center;justify-content: space-between;">
                                <span style="font-size: 14px;"><b>RN:</b> #<?php echo e($invoice->invoice); ?></span>   <span style="font-size: 14px;"><b>Date: </b> <?php echo e($invoice->created_at->format('d-m-Y')); ?></span> 
                            </div>
                            <div style="display: flex;  align-items: center;justify-content: space-between; margin-bottom: 8px;">
                                <span style="font-size: 14px;"><b>CP:</b>  <?php echo e($invoice->mobile); ?></span>   <span style="font-size: 14px;"><b>SP:</b>  <?php echo e($invoice->soldBy?$invoice->soldBy->name:'Staff'); ?></span> 
                            </div>
                            <div class="invoiceBody top">
                                ...
                                <table style="width: 100%;">
                                    <tbody><tr style="border-bottom: 2px dotted #ddd;">
                                        <th style="font-size: 14px; font-weight: 500;">Sub Total</th>
                                        <td style="text-align:end;"><?php echo e(priceFormat($invoice->total_price)); ?></td>
                                    </tr>
                                    <tr style="border-bottom: 2px dotted #ddd;">
                                        <th style="font-size: 14px; font-weight: 500;">Shipping Charge</th>
                                        <td style="text-align:end;"><?php echo e(priceFormat($invoice->shipping_charge)); ?></td>
                                    </tr>
                                    <tr style="border-bottom: 2px dotted #ddd;">
                                        <th style="font-size: 14px; font-weight: 500;">Order Tax</th>
                                        <td style="text-align:end;">(<?php echo e($invoice->tax); ?>%)<?php echo e(priceFormat($invoice->tax_amount)); ?></td>
                                    </tr>
                                    <tr style="border-bottom: 2px dotted #ddd;">
                                        <th style="font-size: 14px; font-weight: 500;">Discount</th>
                                        <td style="text-align:end;"><?php echo e(priceFormat($invoice->discount_amount)); ?></td>
                                    </tr>
                                    <tr style="border-bottom: 2px dotted #ddd;">
                                        <th style="font-size: 14px; font-weight: 500;">Grand Total</th>
                                        <td style="text-align:end;"><?php echo e(priceFormat($invoice->grand_total)); ?></td>
                                    </tr>
                                    <tr style="border-bottom: 2px dotted #ddd;">
                                        <th style="font-size: 14px; font-weight: 500;">Due Total</th>
                                        <td style="text-align:end;"><?php echo e(priceFormat($invoice->due_amount)); ?></td>
                                    </tr>
                                </tbody></table>
                            </div>
...
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\posher-react-laravel\resources\views/admin/pos-orders/orderPosInvoice.blade.php ENDPATH**/ ?>