                                    ...
                                    <div class="col-md-5" style="padding:15px;">
                                        <div class="SearchContain">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control serchProducts" data-url="<?php echo e(route('admin.wholeSalesAction',['search-product',$invoice->id])); ?>" placeholder="Search Product Name" autocomplete="off">
                                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(adminTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/meghfash/demo.meghfashion.com/resources/views/admin/wholesale/ordersManage.blade.php ENDPATH**/ ?>