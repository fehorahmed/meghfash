            ...
            const [filters, setFilters] = useState({
              ...
              const fetchFilteredData = async () => {
                ...
                try {
                  ...
                  const slug = category?category.slug:'search'; // Convert filters to query string
                  const response = await fetch(`/product/filter/${slug}?${queryParams}`, {
                    method: 'GET',
                    headers: {
  ...
  return (
    <MainLayout
        auth={auth}
            ...
            carts={carts}
        >
            <Head title={`Search - ${general.web_title}`} >
                <meta name="title" property="og:title" content={`Search - ${general.web_title}`} />
                    ...
                    <div className="row row-cols-1">
                        <div className="col">
                            <div className="breadcrumb__content text-center">
                                <h1 className="breadcrumb__content--title text-white mb-25">Search: {search}</h1>
                                <ul className="breadcrumb__content--menu d-flex justify-content-center">
                                    <li className="breadcrumb__content--menu__items"><Link className="text-white" href={route('index')}>Home </Link></li>
                                    <li className="breadcrumb__content--menu__items"><span className="text-white">Search: {search}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <div className="col-xl-9 col-lg-8">
                        ...
                        {searchProductLoading ? <p className="text-center">Loading...</p> :
                        <>
