    ...
    return (
        <>
            ...
            >
             ...
             <div class="container">
                <h2 class="cart__title mb-40">About Us</h2>
                 <div class="row">
                     <div class="col-lg-6">
                         <div class="about__thumb d-flex">
                             <div class="about__thumb--items">
                                 <img class="about__thumb--img border-radius-5 display-block" src="/images/img/other/about-thumb-list1.png" alt="about-thumb" />
                             </div>
                             <div class="about__thumb--items position__relative">
                                 <img class="about__thumb--img border-radius-5 display-block" src="/images/img/other/about-thumb-list2.png" alt="about-thumb" />
                                 <div class="banner__bideo--play about__thumb--play">
                                     <a class="banner__bideo--play__icon about__thumb--play__icon glightbox" href="#"  data-gallery="video">
                                     <FaYoutube />
                     ...
                     <div class="col-lg-6">
                         <div class="about__content">
                             ...
                             <p class="about__content--desc mb-20">
                                Welcome to Megh Fashion Design & Creation, your premier destination for unique, high-quality, and beautifully crafted products. 
                                We’re thrilled to have you here and invite you to explore a world of creativity, artistry, and innovation that makes every 
                                piece in our collection special. Whether you’re looking for the perfect addition to your home, a thoughtful gift for someone 
                                special, or a way to express your personal style, Megh Fashion Design & Creation is here to bring your vision to life.
                             </p>
                             <p class="about__content--desc mb-25">
                                 At Megh Fashion Design & Creation, we believe that design is more than just aesthetics—it’s about telling a story,
                                  evoking emotions, and creating lasting memories. Our team is made up of passionate designers, artisans,
                                   and creators who take pride in their craft. Every product we offer is carefully designed with attention 
                                   to detail, ensuring that it not only looks stunning but also serves a meaningful purpose in your life.
                             </p>
                 ...
                 <div class="team__container">
                     <div class="row">
                         <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                             <div class="team__items text-center">
                                 <div class="team__thumb">
                                     <img class="team__thumb--img border-radius-50" src="/images/img/other/team1.png" alt="" />
                                 </div>
                                 <div class="team__content ">
                                     ...
                                     <ul class="team__social d-flex justify-content-center align-items-center">
                                         ...
                                         <li class="team__social--list">
                                             <a class="team__social--icon" target="_blank" href="../../../../www.youtube.com/supported_browsers_c942f037.html">
                         ...
                         <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                             <div class="team__items text-center">
                                 <div class="team__thumb">
                                     <img class="team__thumb--img border-radius-50" src="/images/img/other/team2.png" alt="" />
                                 </div>
                                 <div class="team__content">
                         ...
                         <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                             <div class="team__items text-center">
                                 <div class="team__thumb">
                                     <img class="team__thumb--img border-radius-50" src="/images/img/other/team3.png" alt="" />
                                 </div>
                                 <div class="team__content">
