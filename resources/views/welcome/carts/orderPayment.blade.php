                ...
                <div class="row" style="padding-top: 10px; border-top: 1px solid #e7e8e9;">
                    ...
                    <div class="col-md-8">
                        <ul class="nav nav-tabs">
                            ...
                            @endif @if(App\Models\General::first()->wallet_payment)
                            <li class="nav-item">
                                <a class="nav-link {{$active=='wallet_payment'?'active':''}}" data-toggle="pill" href="#balance">Wallet</a>
                            </li>
                            @endif @if(App\Models\General::first()->online_payment)
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane container {{$active=='online_payment'?'bg-white active':'fade'}}" id="online">
                                <div class="p-5">
                                    <img src="{{asset('public/medies/SS-Commerz-Pay-With-logo.png')}}" width="100%" /> <br />
                                    <br />
                                    <button class="btn" id="sslczPayBtn" token="5" postdata="" order="5" endpoint="/pay-via-ajax" style="background: #f32525; border-color: #f32525; color: white;">Pay Online Now</button>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane container {{$active=='wallet_payment'?'bg-white active':'fade'}}" id="balance">
                                <div class="p-3 bg-white">
                                    <div class="mybalanetotal">
                                        ...
                                        <a class="btn btn-link" href="{{route('customer.myBalance')}}">Add Balance</a><br />
                                        <br />
                                        @else
                                        <a class="btn btn-xs text-center" href="{{route('orderPaymentSend',['wallet',$order->id])}}" style="display: inline-block; background: #f32525; border-color: #f32525; color: white;">
                                            Payment My Wallet
                                        </a>
                                        @endif
                                    </div>
