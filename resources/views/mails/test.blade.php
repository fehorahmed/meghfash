...
<div style="padding:10px;margin: 10px 0;">
    <h2 style="margin: 0;padding: 5px 0;">Welcome to {{general()->title}}, {{$datas['name']}}! </h2>
    <div>
    <p>Thank you for signing up with {{ucfirst(general()->title)}}. To complete your forget password, we just need to verify your email address. This ensures that your account is secure</p>
    ...
    <h4 style="text-align:center;">
        <span style="font-size: 24px;">Verify Code: {{$datas['verifycode']}}</span>
    </h4>
    ...
    <ul>
        ...
        <li style="padding: 3px 0;">
            <b>Access:</b> Gain full access to all features and content on {{general()->title}}.
        </li>
        <li style="padding: 3px 0;">
    ...
    <p>
        If you didn’t sign up for {{general()->title}}, please ignore this email, and no further action will be taken.
    </p>
