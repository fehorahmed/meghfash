...
<div style="padding:10px;margin: 10px 0;">
    <h2 style="margin: 0;padding: 5px 0;">Welcome to {{general()->title}}, </h2>
    <div>
    <p>Thank you for signing up with {{ucfirst(general()->title)}}. To complete your register verify, we just need to verify your email address. This ensures that your account is secure</p>
