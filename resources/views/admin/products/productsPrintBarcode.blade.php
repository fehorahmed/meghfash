                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body" >
                            ...
                            <!--    <form class="{{route('admin.productsAction',['barcode',$product->id])}}">-->
                            <!--        <input type="hidden" value="{{request()->variation_id}}" name="variation_id">-->
                            <!--        <div class="input-group">-->
                            <!--            <input type="number" class="form-control" name="printItems" value="{{$printCount}}" placeholder="Print item count">-->
