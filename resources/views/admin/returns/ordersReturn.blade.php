...
<title>{{websiteTitle('Return orders List')}}</title>
@endsection @push('css')
...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="{{route('admin.ordersReturn')}}">
    ...
    <div class="card-content">
        <div id="accordion">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                    <div class="card-body">
                        <form action="{{route('admin.ordersReturn')}}">
                            <div class="row">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered table-hover" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$i+1}}</td>
                                <td><a href="{{route('admin.ordersReturnAction',['invoice',$order->id])}}">{{$order->invoice}}</a></td>
                                ...
                                <td>
                                    <a href="{{route('admin.ordersReturnAction',['edit',$order->id])}}" class="btn btn-sm btn-success">Edit</a>
                                </td>
                            </tr>
...
<div class="modal fade text-left" id="AddRetun" tabindex="-1" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('admin.ordersReturnAction','create')}}">
