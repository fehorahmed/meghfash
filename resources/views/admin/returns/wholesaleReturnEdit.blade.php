...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a class="btn btn-outline-primary" href="{{route('admin.wholesaleReturn')}}"><i class="fa fa-list"></i> Back</a>
            
            <a class="btn btn-success" href="{{route('admin.wholesaleReturnAction',['invoice',$order->id])}}"><i class="fa fa-print"></i> Invoice</a>
            
            <a class="btn btn-outline-primary" href="{{route('admin.wholesaleReturnAction',['update',$order->id])}}">
    ...
    <section class="basic-elements">
        <div class="row">
            <div class="col-md-12">
			    ...
			    <form  method="post" action="{{route('admin.wholesaleReturnAction',['update',$order->id])}}">
    				@csrf
                            	...
                            	<div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly value="{{$order->name}}" class="form-control">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly value="{{$order->branch?$order->branch->name:''}}" class="form-control">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoice" value="{{$order->invoice}}" readonly class="form-control" placeholder="Enter Invoice No">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{$order->created_at->format('Y-m-d')}}" name="created_at" class="form-control" required="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
				                ...
				                <div class="table-responsive m-t orderItem">
                                    @include(adminTheme().'returns.includes.wholesaleOrderItems')
				                </div>
                            ...
                            <table class="table table-bordered">
                               ...
                               <tr>
                                ...
                                <td>{{$transaction->currency}} {{number_format($transaction->amount,2)}}
                                    ...
                                    <br>
                                    <a href="{{route('admin.wholesaleReturnAction',['payment-delete',$order->id,'transection_id'=>$transaction->id])}}" class="btn btn-danger btn-sm" onclick="return confirm('Are You Want To Delete?')">Delete</a>
                                </td>
                               </tr>
                               @endforeach
	 ...
	 <div class="modal-content">
	   ...
	   <div class="modal-body">
			...
			<div class="tab-content px-1 pt-1" style="border: 1px solid #ddd;">
				...
				<form action="{{route('admin.wholesaleReturnAction',['payment',$order->id])}}" method="post">
					@csrf
