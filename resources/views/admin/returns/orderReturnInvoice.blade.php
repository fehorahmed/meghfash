...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="{{route('admin.ordersReturn')}}">Back</a>
            
            @isset(json_decode(Auth::user()->permission->permission, true)['orders']['manage'])
            <a class="btn btn-outline-primary" href="{{route('admin.ordersReturnAction',['edit',$order->id])}}">Edit</a>
            @endisset
            <button class="btn btn-success" id="PrintAction" ><i class="fa fa-print"></i> Print</button>

            <a class="btn btn-outline-primary" href="{{route('admin.ordersReturnAction',['invoice',$order->id])}}">
                			...
                			<div class="orderInfo">
                				<div class="row" style="flex-wrap: wrap;">
                					<div class="col-3">
                						<p>
											<b>Order To:</b><br>
											<span style="font-size: 18px;"><b>Main Invoice:</b> {{ $order->parentOrder?$order->parentOrder->invoice:'Not Found' }}<br></span>
