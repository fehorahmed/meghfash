...
<div class="content-header row">
   ...
   <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
     <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
       ...
       <a class="btn btn-outline-primary reloadPage" href="{{route('admin.usersAdmin')}}">
       		Back
       	</a>
                        ...
                        <form action="{{route('admin.usersAdminAction',['update',$user->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 form-group">
                                    ...
                                    <textarea class="form-control {{$errors->has('profile')?'error':''}}" name="profile" placeholder="Enter Profile Details" >{{$user->profile?:old('profile')}}</textarea>
                                    @if ($errors->has('profile'))
                                    <p style="color: red; margin: 0;">{{ $errors->first('profile') }}</p>
                                    @endif
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 form-group">
                                    ...
                                    <!--<div class="custom-control custom-checkbox">-->
                                    <!--    <input type="checkbox" class="custom-control-input" name="featured" id="featured" {{$user->fetured?'checked':''}}/>-->
                                ...
                                <div class="col-xl-4 col-lg-12 col-md-12 form-group">
                                    ...
                                    @if ($errors->has('role'))
                                    <p style="color: red; margin: 0;">{{ $errors->first('role') }}</p>
                                    @endif
                                </div>
