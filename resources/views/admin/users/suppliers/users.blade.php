...
@section('title')
<title>{{websiteTitle('Suppllier Users')}}</title>
@endsection 
@push('css')
    ...
    <div class="card-content">
        <div id="accordion">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="border: 1px solid #00b5b8; border-top: 0;">
                <div class="card-body">
                    <form action="{{route('admin.usersSupplier')}}">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-1">
                                <div class="input-group">
                                    <input type="text" name="search" value="{{request()->search?:''}}" placeholder="Suppllier Name, Email, Mobile" class="form-control {{$errors->has('search')?'error':''}}" />
    ...
    <div class="card-content">
        ...
        <form action="{{route('admin.usersSupplier')}}">
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="statuslist">
                        <li><a href="{{route('admin.usersSupplier')}}">All ({{$totals->total}})</a></li>
                        <li><a href="{{route('admin.usersSupplier',['status'=>'active'])}}">Active ({{$totals->active}})</a></li>
                        <li><a href="{{route('admin.usersSupplier',['status'=>'inactive'])}}">Inactive ({{$totals->inactive}})</a></li>
                    </ul>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('admin.usersSupplierAction',['edit',$user->id])}}" class="invoice-action-view mr-1">{{$user->name}}</a></td>
                            <td>{{$user->email}}</td>
                            <td>
                                @if($user->status)
                            ...
                            <td style="padding:0; text-align: center;">
                                <a href="{{route('admin.usersSupplierAction',['edit',$user->id])}}" class="btn btn-md btn-info">
                                    <i class="fa fa-edit"></i> Edit
                                </a>

                                @if($user->id==Auth::id()) @else
                                <a href="{{route('admin.usersSupplierAction',['delete',$user->id])}}" onclick="return confirm('Are You Want To Delete')" class="btn btn-md btn-danger">
 ...
 <div class="modal fade text-left" id="AddUser" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
	 <div class="modal-content">
	 	<form action="{{route('admin.usersSupplierAction','create')}}" method="post">
	   		@csrf
	   ...
	   <div class="modal-body">
			 ...
			 <div class="form-group">
				...
				<input type="email" class="form-control {{$errors->has('email_mobile')?'error':''}}" name="email_mobile" placeholder="Enter Email" required="">
