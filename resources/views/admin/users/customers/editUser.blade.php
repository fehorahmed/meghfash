   ...
   <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
     <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
       ...
       <a class="btn btn-outline-primary" href="{{route('admin.usersCustomer')}}">
       	...
       	<a class="btn btn-outline-primary" href="{{route('admin.usersCustomerAction',['edit',$user->id])}}">
                        ...
                        <form action="{{route('admin.usersCustomerAction',['update',$user->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body mt-75">
                                    <div class="col-12 px-0 d-flex flex-sm-row flex-column justify-content-start">
                                        ...
                                        <input type="file" name="image" id="account-upload" class="profile-upload" data-imageshow="image_{{$user->id}}" hidden="" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                                    ...
                                    <p style="color: red; margin: 0;">{{ $errors->first('gender') }}</p>
                                    @endif
                                </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('address')?'error':''}}" name="member_card_id" placeholder="Enter Card ID" value="{{$user->member_card_id?:old('member_card_id')}}" style="border-color: #ff9864;" />
                                    @if ($errors->has('member_card_id'))
                                    <p style="color: red; margin: 0;">{{ $errors->first('member_card_id') }}</p>
                                    @endif
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                                    ...
                                    <input type="date" class="form-control {{$errors->has('created_at')?'error':''}}" name="created_at"  value="{{$user->created_at->format('Y-m-d')}}" />
