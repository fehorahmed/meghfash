                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.usersCustomerAction',['view',$user->id])}}" class="invoice-action-view mr-1">{{$user->name}}</a>
                                @if($user->member_card_id)
                                <small style="color: #ff864a;font-weight: bold;"><br><b>M/C:</b> {{$user->member_card_id}}</small>
                                @endif
                            </td>
                            ...
                            <td style="padding:0; text-align: center;">
                                <a href="{{route('admin.usersCustomerAction',['edit',$user->id])}}" class="btn btn-md btn-info">
                                ...
                                <a href="{{route('admin.usersCustomerAction',['delete',$user->id])}}" onclick="return confirm('Are You Want To Delete')" class="btn btn-md btn-danger">
