        ...
        <div class="col-md-7">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{route('admin.usersWholesaleCustomerAction',['update',$user->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="media">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('company_name')?'error':''}}" name="company_name" placeholder="Enter Company name" value="{{$user->company_name?:old('company_name')}}" required="" />
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('name')?'error':''}}" name="name" placeholder="Enter customer Name" value="{{$user->name?:old('name')}}" required="" />
                                    @if ($errors->has('name'))
