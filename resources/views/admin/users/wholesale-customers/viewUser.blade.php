   ...
   <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
     <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
       ...
       <a class="btn btn-outline-primary" href="{{route('admin.usersCustomer')}}">
       	...
       	<a class="btn btn-outline-primary" href="{{route('admin.usersWholesaleCustomerAction',['view',$user->id])}}">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Total Sale</th>
                                    <td>{{priceFullFormat($user->orders->where('order_status','delivered')->where('order_type','wholesale_order')->sum('grand_total'))}}</td>
                                </tr>
                                <tr>
                                    <th>Total Due</th>
                                    <td>{{priceFullFormat($user->orders->where('order_status','delivered')->where('order_type','wholesale_order')->sum('due_amount'))}}
                                        
                                        <a href="{{route('admin.usersWholesaleCustomerAction',['view',$user->id,'payment_status'=>'due'])}}"><i class="fas fa-external-link-alt"></i></a>
                                    </td>
                                </tr>
                            </table>
                        </div>
