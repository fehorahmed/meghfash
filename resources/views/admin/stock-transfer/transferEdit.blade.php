...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a class="btn btn-outline-primary" href="{{route('admin.stockTransfer')}}"><i class="fa fa-list"></i> Back</a>
            <a class="btn btn-outline-primary" href="{{route('admin.stockTransferAction',$invoice->id)}}">
			...
			@include('admin.alerts')
            	<div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{route('admin.stockTransferAction',['update',$invoice->id])}}" method="post">
                                    @csrf
                            <div class="updateForm">
                            
                                <div class="orderInformation">
                                    @include(adminTheme().'stock-transfer.includes.transferInformation')
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-5" style="padding:15px;">
                                        <div class="SearchContain">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control serchProducts" data-url="{{route('admin.stockTransferAction',['search-product',$invoice->id])}}" placeholder="Search Product Name, ID" autocomplete="off">
                                            </div>
                                            <div class="searchResultlist">
                                                @include(adminTheme().'stock-transfer.includes.searchResult')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-4" style="padding:15px;">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control serchBarcodeProdut" data-url="{{route('admin.stockTransferAction',['search-barcode-product',$invoice->id])}}" placeholder="Search Product Barcode" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="purchaseItemsSection">
                    	            ...
                    	            @include(adminTheme().'stock-transfer.includes.transferItems')
