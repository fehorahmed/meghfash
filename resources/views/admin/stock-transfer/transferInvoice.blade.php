...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <a class="btn btn-outline-primary" href="{{route('admin.stockTransferAction',['edit',$invoice->id])}}"><i class="fa fa-edit"></i> Edit</a>
            <a href="javascript:void(0)" id="PrintAction22" class="btn btn-outline-primary">
                 <i class="bx bx-printer"></i> Print
             </a>
            <a class="btn btn-outline-primary" href="{{route('admin.stockTransferAction',['invoice',$invoice->id])}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="invoice-info">
                                            <b>From Warehouse</b>: {{$invoice->formBranch?$invoice->formBranch->name:''}}<br>
                                            {{$invoice->formBranch?$invoice->formBranch->description:''}}<br>
