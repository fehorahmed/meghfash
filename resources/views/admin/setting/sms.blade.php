                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                            ...
                            <select name="sms_type" class="form-control {{$errors->has('sms_type')?'error':''}}">
                                <option value="Non-Masking" {{$general->sms_type=='Non Masking'?'selected':''}}>Non-Masking</option>
                                <option value="Masking" {{$general->sms_type=='Masking'?'selected':''}}>Masking</option>
                            </select>
