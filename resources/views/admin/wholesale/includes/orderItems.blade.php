...
<div class="table-responsive">                 
		<table class="table table-bordered">
			<tr>
				...
				<th style="min-width:150px;width:150px;">Wholesale Price</th>
			...
			<tr>
				<td>{{++$i}}</td>
				<td><img src="{{asset($item->image())}}" style="max-height: 40px;max-width: 100%;"></td>
				<td>
				...
				<td style="padding:3px;">
					...
					data-url="{{route('admin.wholeSalesAction',['item-quantity',$invoice->id])}}"
				...
				<td style="padding:3px;">
					...
					data-url="{{route('admin.wholeSalesAction',['item-price',$invoice->id])}}"
					data-id="{{$item->id}}" class="form-control form-control-sm itemUpdatePurchase" placeholder="Enter Price" step="any" style="text-align: center;"
					>
				</td>
				<td style="text-align: center;">{{priceFormat($item->total_price)}}</td>
				<td style="text-align: center;">
    				<span class="badge badge-danger itemRemove" data-url="{{route('admin.wholeSalesAction',['remove-item',$invoice->id])}}" data-id="{{$item->id}}" style="cursor:pointer;"> <i class="fa fa-trash"></i> </span>
				</td>
			</tr>
			@endforeach
			...
			<tr>
				...
				<td style="text-align: center;" >{{priceFormat($invoice->grand_total)}}</td>
				<td></td>
			</tr>
			<!--<tr>-->
	...
	<div class="row">
		...
		<div class="col-md-4">
		    <div class="form-group mb-1">
    		        ...
    		        <input type="number" class="form-control itemUpdatePurchase" value="{{$invoice->adjustment_amount}}" placeholder="Amount" data-id="0" data-url="{{route('admin.wholeSalesAction',['adjustment-amount',$invoice->id])}}" >
    		</div>
