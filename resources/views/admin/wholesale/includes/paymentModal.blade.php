	 ...
	 <div class="modal-content">
	   ...
	   <div class="modal-body">
			...
			<div class="tab-content px-1 pt-1" style="border: 1px solid #ddd;">
				...
				<form action="{{route('admin.wholeSalesAction',['payment',$invoice->id])}}" method="post">
					@csrf
					<input type="hidden" value="0" name="transaction_type">
					
					<div class="form-group">
					    <label>Payment Date</label>
					    <input type="date" value="{{$invoice->created_at->format('Y-m-d')}}" class="form-control" name="created_at">
					</div>
					<div class="form-group">
						<label>Amount</label>
						<input type="number" class="form-control PayAmount" step="any" name="amount" placeholder="Enter Amount" value="{{$invoice->due_amount?:''}}">
					</div>
					<div class="form-group">
						<label>Method</label>
