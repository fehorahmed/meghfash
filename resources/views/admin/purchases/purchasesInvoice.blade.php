...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-md-0 mb-2">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a class="btn btn-outline-primary" href="{{route('admin.purchases')}}"><i class="fa fa-list"></i> Back</a>
            <a class="btn btn-outline-primary" href="{{route('admin.purchasesAction',['edit',$invoice->id])}}"><i class="fa fa-list"></i> Edit</a>
            <a href="javascript:void(0)" id="PrintAction22" class="btn btn-outline-primary">
                 <i class="bx bx-printer"></i> Print
             </a>
            <a class="btn btn-outline-primary" href="{{route('admin.purchasesAction',$invoice->id)}}">
                         ...
                         <div class="invoice-inner invoicePage PrintAreaContact">
                            <style>
                                    ...
                                    <div class="demo-info">
                                            ...
                                            <h6 style="font-size: 20px;border-top: 1px solid #cccccc;padding-top: 5px;margin:0;font-weight: bold;">STOCK INVOICE</h6>
                                    </div>
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-4">
                                            ...
                                            <b>Created By:</b> {{$invoice->soldBy?$invoice->soldBy->name:''}}
                                    </div>
                                    <div class="col-4"></div> 
                                    <div class="col-4">
                                        <div class="invoice-info">
                                            <b>Supplier</b>: {{$invoice->user?$invoice->user->name:''}}<br>
                                            <b>Warehouse</b>: {{$invoice->branch?$invoice->branch->name:''}}<br>
                                ...
                                <div class="invoice-products">
                                    ...
                                    <table class="table table-bordered" style="width: 100% !important;">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 100px;min-width: 100px;text-align: center;">PRICE ({{general()->currency}})</th>
                                            <th style="width: 120px;min-width: 120px;text-align: center;">TOTAL PRICE ({{general()->currency}})</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <!--    <th style="text-align: center;font-size:16px;">{{priceFormat($invoice->shipping_charge)}}</th>-->
                                        <!--</tr>-->
                                        <!--<tr>-->
                                        <!--    <td></td>-->
                                        <!--    <td></td>-->
                                        <!--    <th colspan="2" style="text-align: end;font-size:16px;">Tax({{$invoice->tax}}%)</th>-->
                                        <!--    <th style="text-align: center;font-size:16px;">{{priceFormat($invoice->tax_amount)}}</th>-->
                                        <!--</tr>-->
                                        <!--<tr>-->
                                        <!--    <td></td>-->
                                        <!--    <td></td>-->
                                        <!--    <th colspan="2" style="text-align: end;font-size:16px;">(-) Discount @if($invoice->discount_type!='flat')({{$invoice->discount}}%)@endif</th>-->
                                        <!--    <th style="text-align: center;font-size:16px;">{{priceFormat($invoice->discount_amount)}}</th>-->
                                        <!--</tr>-->
                                        <!--<tr>-->
                                        <!--    <td></td>-->
                                        <!--    <td></td>-->
