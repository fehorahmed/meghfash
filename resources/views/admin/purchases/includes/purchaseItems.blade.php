		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td style="padding:3px;">
					...
					data-url="{{route('admin.purchasesAction',['item-quantity',$invoice->id])}}"
				...
				<td style="padding:3px;">
					...
					data-url="{{route('admin.purchasesAction',['item-price',$invoice->id])}}"
				...
				<td style="text-align: center;">
    				<span class="badge badge-danger itemRemove" data-url="{{route('admin.purchasesAction',['remove-item',$invoice->id])}}" data-id="{{$item->id}}" style="cursor:pointer;"> <i class="fa fa-trash"></i> </span>
				</td>
			</tr>
			@endforeach
