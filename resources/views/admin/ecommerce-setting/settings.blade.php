                                                         ...
                                                         <td style="padding:3px;">
                                                                <div class="row m-0">
                                                                     <div class="col-6 p-0">
                                                                        ...
                                                                        <input type="number" class="form-control form-control-sm" name="tax" value="{{(float)general()->tax}}" step="any" placeholder="Enter Vat">
                                                                     </div>
                                                                     <div class="col-6 p-0">
                                                                        <label>Import Vat (%)</label>
                                                                        <input type="number" class="form-control form-control-sm" name="import_tax" value="{{(float)general()->import_tax}}" step="any" placeholder="Enter Import Vat">
                                                                     </div>
                                                                </div>
                                                             <!--<div class="input-group">-->
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td style="padding:3px;">
                                                             <select class="form-control form-control-sm" name="online_store_id" required="">
                                                                 ...
                                                                 @foreach(App\Models\Attribute::latest()->where('type',5)->where('status','active')->get() as $store)
                                                                 <option value="{{$store->id}}" {{general()->online_store_id==$store->id?'selected':''}} >{{$store->name}}</option>
                                                                 @endforeach
                                                             </select>
                                                         </td>
                                                     </tr>
