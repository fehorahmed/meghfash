                        ...
                        <div class="card-body">
                            <div id="accordionWrapa1" role="tablist" aria-multiselectable="true">
                                <div class="card accordion">
                                    ...
                                    @include(adminTheme().'menus.includes.productCategoryList')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" name="location">
                                                    ...
                                                    <option value="Category Menus" {{$parent->location=='Category Menus'?'selected':''}}>Category Menus</option>
                                                    <option value="Offer Category" {{$parent->location=='Offer Category'?'selected':''}}>Offer Category</option>
                                        ...
                                        <li class="ui-sortable-handle" @if(!$menuli->
                                            ...
                                            <span style="cursor: move;">
                                                ...
                                                <span style="color: #d8d8d8;">
                                                    ( @if($menuli->menu_type==1) Page @elseif($menuli->menu_type==2) Post Category @elseif($menuli->menu_type==3) Product Category @elseif($menuli->menu_type==0) Custom @endif )
                                                </span>
