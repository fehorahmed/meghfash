...
<title>Customer Reports - {{general()->title}} | {{general()->subtitle}}</title>
@endsection @push('css')
<link rel="stylesheet" type="text/css" href="{{asset(assetLinkAdmin().'/app-assets/vendors/css/tables/datatable/datatables.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset(assetLinkAdmin().'/app-assets/vendors/css/tables/extensions/buttons.dataTables.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset(assetLinkAdmin().'/app-assets/vendors/css/tables/datatable/buttons.bootstrap4.min.css')}}" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-5 mb-1">
                                                    <div class="input-group">
                                                        <input type="date" name="startDate" value="{{$from->format('Y-m-d')}}" class="form-control" />
                                                        <input type="date" name="endDate"  value="{{$to->format('Y-m-d')}}" class="form-control" />
                                                    </div>
                                                </div>
                                                <div class="col-md-7 mb-1">
                                                    <div class="input-group">
                                                        <input type="text" name="search" value="{{request()->search}}" placeholder="Search Customer Name, Email" class="form-control" />
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataex-html5-export">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$customer->cityN?$customer->cityN->name:''}}</td>
                                                <td>{{$customer->districtN?$customer->districtN->name:''}}</td>
                                                <td>BD</td>
                                                <td>{{$customer->dob?Carbon\Carbon::parse($customer->dob)->format('m-d-Y'):''}}</td>
                                                <td></td>
                                                <td>
                                                ...
                                                <td>{{ $customer->dob ? \Carbon\Carbon::parse($customer->dob)->age : '' }}</td>
                                                <td>{{$customer->orders()->whereIn('order_type',['customer_order','pos_order'])->whereIn('order_status',['confirmed', 'delivered', 'shipped'])->count()}}</td>
                                                <td>{{priceFullFormat($customer->orders()->whereIn('order_type',['customer_order','pos_order'])->whereIn('order_status',['confirmed', 'delivered', 'shipped'])->sum('grand_total'))}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
...
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/datatable/datatables.min.js')}}"></script>
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"></script>
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/datatable/buttons.bootstrap4.min.js')}}"></script>
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/jszip.min.js')}}"></script>
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/pdfmake.min.js')}}"></script>
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/vfs_fonts.js')}}"></script>
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/buttons.html5.min.js')}}"></script>
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/buttons.print.min.js')}}"></script>
<script src="{{asset(assetLinkAdmin().'/app-assets/vendors/js/tables/buttons.colVis.min.js')}}"></script>
