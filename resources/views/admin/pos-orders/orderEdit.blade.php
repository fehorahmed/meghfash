...
<title>{{websiteTitle('Orders List')}}</title>
@endsection @push('css')
<style type="text/css">
     .card .card-header {
        margin-bottom: 10px;
                ...
                <div class="card-body" style="padding:10px;">
                    <div class="SaleHead">
                        <div class="shoppingCart">
                            @include(adminTheme().'pos-orders.includes.shoppingCart')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mb-30">
                ...
                <div class="card-body">
                        <div class="row" style="margin:0 -5px;">
                            <div class="col-md-12" style="padding:5px;">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control seachProduct" data-url="{{route('admin.posOrdersAction',['productFilter',$invoice->id])}}" placeholder="Search Name,Barcode,ID" autocomplete="off">
                                    <div class="input-group-append">
                            ...
                            <div class="col-md-6" style="padding:5px;">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm categoryFilter" data-type="category" data-url="{{route('admin.posOrdersAction',['productFilter',$invoice->id])}}">
                            ...
                            <div class="col-md-6" style="padding:5px;">
                                <div class="form-group">
                                    <label>Brand</label>
                                    <select class="form-control form-control-sm brandFilter" data-type="brand" data-url="{{route('admin.posOrdersAction',['productFilter',$invoice->id])}}">
                    ...
                    <div class="productList">
                        @include(adminTheme().'pos-orders.includes.productsList')
                    </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function(){
        ...
        function submitOrder(){
            ...
            if(total > amount){
                ...
                let form = $('.SaleInfo');
                let redirectUrl = "{{ route('admin.posOrdersAction', 'create') }}";
        ...
        $(document).on('change','.adJustmentDiscount',function(){
            var url =$('.adJustmentDiscount').data('url');
            var key =$('.adJustmentDiscount').val();
            if(key==null || key=='' || key=='undefined'){
                key =0;
            }
