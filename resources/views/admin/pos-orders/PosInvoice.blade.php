                        ...
                        <style type="text/css">
                            ...
                            <div class="invoiceHead">
                                <div style="display: flex;">
                                    <div>
                                        <img src="{{asset(general()->posLogo())}}" style="max-height: 100px;max-width: 75px; margin-bottom: 5px;">
                                    </div>
                                ...
                                <p>
                                    ...
                                    <span style="margin-bottom: 10px;color: black;"><b>Contact : </b>{{general()->mobile}} </span>
                            ...
                            <!--</div>-->
                            <div style="text-align:center;">
                                <span style="font-size: 14px;color: black;font-weight: bold;"><b>Invoice:</b> #{{$invoice->invoice}}</span> ,  <span style="font-size: 14px;color: black;font-weight: bold;"><b>Date: </b> {{ $invoice->created_at->format('d M y h:i A') }}</span> 
                            </div>
                            ...
                            <div class="invoiceBody top">
                                <table class="table" style="min-width:100%;">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @if(count($item->itemAttributes()) > 0)
                							    @foreach($item->itemAttributes() as $i=>$attri)
                                                    @if(isset($attri['title']) && isset($attri['value']) && $attri['title']=='Size')
                                                    ({{$attri['value']}})
                                                    @endif
                                                @endforeach
                							@endif
                                        ...
                                        <td style="text-align: center">{{priceFormat($item->regular_price+($item->regular_price*$item->tax/100))}}</td>
                                        <!--<td style="text-align: center">{{priceFormat($item->tax_amount)}}-->
                                        <!--({{(float) $item->tax}}%)-->
                                        <!--</td>-->
                                        <td style="text-align:end;">{{priceFormat(($item->regular_price+($item->regular_price*$item->tax/100))*$item->quantity)}}</td>
                                    </tr>
                                    @endforeach
                                ...
                                <table style="width: 100%;">
                                    <tbody><tr style="">
                                        ...
                                        <td style="text-align:end;width:80px;min-width:80px;">{{number_format($invoice->totalRegularPrice(),2)}}</td>
                                    </tr>
                                    ...
                                    <tr style="">
                                        ...
                                        <td style="text-align:end;">{{number_format($invoice->adjustment_amount,2)}}</td>
                                    </tr>
                                    @endif
                                    <!--<tr style="">-->
