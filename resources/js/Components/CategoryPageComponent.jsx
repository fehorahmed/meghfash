                 ...
                 <div className="row row-cols-1">
                     <div className="col">
                         <div className="breadcrumb__content text-center">
                             <h1 className="breadcrumb__content--title text-white mb-25">Shop Page </h1>
                             <ul className="breadcrumb__content--menu d-flex justify-content-center">
                                 <li className="breadcrumb__content--menu__items"><a className="text-white" href="index.html">Home </a></li>
                                 <li className="breadcrumb__content--menu__items"><span className="text-white">Shop Page </span></li>
                             </ul>
                         </div>
                     </div>
                 </div>
                     ...
                     <div className="product__view--mode d-flex align-items-center">
                         ...
                         <div className="product__view--mode__list">
                             <div className="product__grid--column__buttons d-flex justify-content-center">
                                 <button className="product__grid--column__buttons--icons active" aria-label="product grid button" data-toggle="tab" data-target="#product_grid">
                                 ...
                                 <button className="product__grid--column__buttons--icons" aria-label="product list button" data-toggle="tab" data-target="#product_list">
                                 ...
                                 <ul className="widget__categories--menu">
                                     <li className="widget__categories--menu__list">
                                         <label className="widget__categories--menu__label d-flex align-items-center">
                                             <img className="widget__categories--menu__img" src="/images/img/product/small-product1.png" alt="categories-img" />
                                         ...
                                         <ul className="widget__categories--sub__menu">
                                             <li className="widget__categories--sub__menu--list">
                                                 <a className="widget__categories--sub__menu--link d-flex align-items-center" href="shop.html">
                                                     <img className="widget__categories--sub__menu--img" src="/images/img/product/small-product2.png" alt="categories-img" />
                                                     <span className="widget__categories--sub__menu--text">Jacket, Women </span>
                                                 </a>
                                             </li>
                                             <li className="widget__categories--sub__menu--list">
                                                 <a className="widget__categories--sub__menu--link d-flex align-items-center" href="shop.html">
                                                     <img className="widget__categories--sub__menu--img" src="/images/img/product/small-product3.png" alt="categories-img" />
                                                     <span className="widget__categories--sub__menu--text">Woolend Jacket </span>
                                                 </a>
                                             </li>
                                             <li className="widget__categories--sub__menu--list">
                                                 <a className="widget__categories--sub__menu--link d-flex align-items-center" href="shop.html">
                                                     <img className="widget__categories--sub__menu--img" src="/images/img/product/small-product4.png" alt="categories-img" />
                                                     <span className="widget__categories--sub__menu--text">Western denim </span>
                                                 </a>
                                             </li>
                                             <li className="widget__categories--sub__menu--list">
                                                 <a className="widget__categories--sub__menu--link d-flex align-items-center" href="shop.html">
                                                     <img className="widget__categories--sub__menu--img" src="/images/img/product/small-product5.png" alt="categories-img" />
                                     ...
                                     <li className="widget__categories--menu__list">
                                         <label className="widget__categories--menu__label d-flex align-items-center">
                                             <img className="widget__categories--menu__img" src="/images/img/product/small-product2.png" alt="categories-img" />
                                     ...
                                     <li className="widget__categories--menu__list">
                                         <label className="widget__categories--menu__label d-flex align-items-center">
                                             <img className="widget__categories--menu__img" src="/images/img/product/small-product3.png" alt="categories-img" />
                                         ...
                                         <ul className="widget__categories--sub__menu">
                                             <li className="widget__categories--sub__menu--list">
                                                 <a className="widget__categories--sub__menu--link d-flex align-items-center" href="shop.html">
                                                     <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product2.png" alt="categories-img" />
                                                     <span className="widget__categories--sub__menu--text">Jacket, Women </span>
                                                 </a>
                                             </li>
                                             <li className="widget__categories--sub__menu--list">
                                             ...
                                             <li className="widget__categories--sub__menu--list">
                                                 <a className="widget__categories--sub__menu--link d-flex align-items-center" href="shop.html">
                                                     <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product4.png" alt="categories-img" />
                                                     <span className="widget__categories--sub__menu--text">Western denim </span>
                                                 </a>
                                             </li>
                                             <li className="widget__categories--sub__menu--list">
                                                 <a className="widget__categories--sub__menu--link d-flex align-items-center" href="shop.html">
                                                     <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product5.png" alt="categories-img" />
                                                     <span className="widget__categories--sub__menu--text">Mini Dresss </span>
                                                 </a>
                                             </li>
                                         </ul>
                                     ...
                                     <li className="widget__categories--menu__list">
                                         <label className="widget__categories--menu__label d-flex align-items-center">
                                             <img className="widget__categories--menu__img" src="/images/img/product/small-product4.png" alt="categories-img" />
                                     ...
                                     <li className="widget__categories--menu__list">
                                         <label className="widget__categories--menu__label d-flex align-items-center">
                                             <img className="widget__categories--menu__img" src="/images/img/product/small-product5.png" alt="categories-img" />
                                             <span className="widget__categories--menu__text">Denim Jacket </span>
                                             <svg className="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                                                 <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                             </svg>
                             ...
                             <div className="single__widget widget__bg">
                                 ...
                                 <ul className="widget__form--check">
                                     <li className="widget__form--check__list">
                                         <label className="widget__form--check__label" for="check1">Denim shirt </label>
                                         <input className="widget__form--check__input" id="check1" type="checkbox" />
                                         <span className="widget__form--checkmark"></span>
                                     </li>
                                     <li className="widget__form--check__list">
                                         <label className="widget__form--check__label" for="check2">Need Winter </label>
                                         <input className="widget__form--check__input" id="check2" type="checkbox" />
                                         <span className="widget__form--checkmark"></span>
                                     </li>
                                     <li className="widget__form--check__list">
                                         <label className="widget__form--check__label" for="check3">Fashion Trends </label>
                                         <input className="widget__form--check__input" id="check3" type="checkbox" />
                                         <span className="widget__form--checkmark"></span>
                                     </li>
                                     <li className="widget__form--check__list">
                                         <label className="widget__form--check__label" for="check4">Oversize Cotton </label>
                                         <input className="widget__form--check__input" id="check4" type="checkbox" />
                                         <span className="widget__form--checkmark"></span>
                                     </li>
                                     <li className="widget__form--check__list">
                                         <label className="widget__form--check__label" for="check5">Baking material </label>
                                         ...
                                         <div className="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                                 ...
                                                 <div className="product__items ">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="#">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product1.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product2.png" alt="product-img" />
                                                         </a>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items ">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product3.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product4.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product5.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product6.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                                     ...
                                                     <div className="product__items--content">
                                                         <span className="product__items--content__subtitle">Jacket, Women </span>
                                                         <h4 className="product__items--content__title"><a href="#">Quilted Shoulder Bag  </a></h4>
                                                         <div className="product__items--price">
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product7.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product8.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product9.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product10.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product11.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product12.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product13.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product14.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                                     ...
                                                     <div className="product__items--content">
                                                         <span className="product__items--content__subtitle">Jacket, Women </span>
                                                         <h4 className="product__items--content__title"><a href="#">Aware organic cotton </a></h4>
                                                         <div className="product__items--price">
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product14.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product15.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                                     ...
                                                     <div className="product__items--content">
                                                         <span className="product__items--content__subtitle">Jacket, Women </span>
                                                         <h4 className="product__items--content__title"><a href="#">Western denim shirt </a></h4>
                                                         <div className="product__items--price">
                                                             <span className="current__price">$115 </span>
                                                             <span className="price__divided"></span>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product2.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product1.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     ...
                                                     <div className="product__items--content">
                                                         <span className="product__items--content__subtitle">Jacket, Women </span>
                                                         <h4 className="product__items--content__title"><a href="#">High Ankle Jeans </a></h4>
                                                         <div className="product__items--price">
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product6.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product5.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product8.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product7.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product10.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product11.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                                         </div>
                                                     ...
                                                     <div className="product__items--content">
                                                         <span className="product__items--content__subtitle">Jacket, Women </span>
                                                         <h3 className="product__items--content__title h4"><a href="#">Oversize Cotton Dress </a></h3>
                                                         <div className="product__items--price">
                                                             <span className="current__price">$110 </span>
                                                             <span className="price__divided"></span>
                                                             <span className="old__price">$78 </span>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items">
                                                     <div className="product__items--thumbnail">
                                                         <a className="product__items--link" href="product-details.html">
                                                             <img className="product__items--img product__primary--img" src="/images/img/product/product15.png" alt="product-img" />
                                                             <img className="product__items--img product__secondary--img" src="/images/img/product/product14.png" alt="product-img" />
                                                         </a>
                                                         <div className="product__badge">
                                                             <span className="product__badge--items sale">Sale </span>
                                         ...
                                         <div className="row row-cols-1 mb--n30">
                                             <div className="col mb-30">
                                                 <div className="product__items product__list--items d-flex">
                                                     ...
                                                     <div className="product__list--items__content">
                                                         ...
                                                         <h3 className="product__list--items__content--title h4 mb-10"><a href="product-details.html">Oversize Cotton Dress </a></h3>
                                                         ...
                                                         <p className="product__list--items__content--desc d-none d-xl-block mb-15">Lorem, ipsum dolor sit ____ consectetur adipisicing elit. Quia ________ dolore doloribus architecto sequi ________ deleniti officia culpa dolor ____ consectetur eligendi, natus at ___ ab quae amet molestiae ____ voluptates, illo exercitationem numquam ____. Est fuga ex ipsum _____ ipsa quibusdam magni harum ______ voluptate, esse deserunt saepe _______. </p>
                                                         <ul className="product__items--action d-flex">
                                                         <li className="product__items--action__list">
                                                                 <a className="product__items--action__btn add__to--cart" href="cart.html">
                                                                 <IoCartOutline />
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items product__list--items d-flex">
                                                     ...
                                                     <div className="product__list--items__content">
                                                         <span className="product__items--content__subtitle mb-5">Jacket, Women </span>
                                                         <h3 className="product__list--items__content--title h4 mb-10"><a href="#">Boxy Denim Jacket </a></h3>
                                                         <div className="product__list--items__price mb-10">
                                                             <span className="current__price">$120 </span>
                                                             <span className="price__divided"></span>
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items product__list--items d-flex">
                                                     ...
                                                     <div className="product__list--items__content">
                                                         <span className="product__items--content__subtitle mb-5">Jacket, Women </span>
                                                         <h3 className="product__list--items__content--title h4 mb-10"><a href="#">Quilted Shoulder Bag </a></h3>
                                                         <div className="product__list--items__price mb-10">
                                                             <span className="current__price">$115 </span>
                                                             <span className="price__divided"></span>
                                                             <span className="old__price">$68 </span>
                                                         ...
                                                         <ul className="product__items--action d-flex">
                                                             <li className="product__items--action__list">
                                                                 <a className="product__items--action__btn add__to--cart" href="cart.html">
                                                                     ...
                                                                     <span className="add__to--cart__text"> + Add to ____ </span>
                                                                 </a>
                                                             </li>
                                                             <li className="product__items--action__list">
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items product__list--items d-flex">
                                                     ...
                                                     <div className="product__list--items__content">
                                                         <span className="product__items--content__subtitle mb-5">Jacket, Women </span>
                                                         <h3 className="product__list--items__content--title h4 mb-10"><a href="product-details.html">Square Shoulder Bag </a></h3>
                                                         <div className="product__list--items__price mb-10">
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items product__list--items d-flex">
                                                     ...
                                                     <div className="product__list--items__content">
                                                         <span className="product__items--content__subtitle mb-5">Jacket, Women </span>
                                                         <h3 className="product__list--items__content--title h4 mb-10"><a href="product-details.html">Light Denim Jackets </a></h3>
                                                         <div className="product__list--items__price mb-10">
                                             ...
                                             <div className="col mb-30">
                                                 <div className="product__items product__list--items d-flex">
                                                     ...
                                                     <div className="product__list--items__content">
                                                         <span className="product__items--content__subtitle mb-5">Jacket, Women </span>
                                                         <h4 className="product__list--items__content--title mb-10"><a href="product-details.html">OSmock Mini Dresss </a></h4>
                                                         <div className="product__list--items__price mb-10">
                                                             <span className="current__price">$125 </span>
                                                             <span className="price__divided"></span>
